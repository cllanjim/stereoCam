...
// MBOOL
// DeNoiseNode::
// getOBoffset(dip_x_reg_t* dip_reg, BMDN_HAL_IN_DATA &rInData)
// {
//     rInData.OBOffsetBayer[0] = OB_TO_INT(dip_reg->DIP_X_OBC2_OFFST0.Raw);
//     rInData.OBOffsetBayer[1] = OB_TO_INT(dip_reg->DIP_X_OBC2_OFFST1.Raw);
//     rInData.OBOffsetBayer[2] = OB_TO_INT(dip_reg->DIP_X_OBC2_OFFST2.Raw);
//     rInData.OBOffsetBayer[3] = OB_TO_INT(dip_reg->DIP_X_OBC2_OFFST3.Raw);
//     return MTRUE;
// }
/*******************************************************************************
 *
