...
MVOID prepareN3DInputImgInfoMap(ImgInfoMapPtr& pToN3DImgInfo, sp<EffectRequest> &pEffReq)
{
    ...
    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_FE1BO, sm_FE1BO);
    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_FE2BO, sm_FE2BO);
    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_FE1CO, sm_FE1CO);
    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_FE2CO, sm_FE2CO);
    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_FMBO_LR, sm_FMBO_LR);
    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_FMBO_RL, sm_FMBO_RL);
    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_FMCO_LR, sm_FMCO_LR);
    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_FMCO_RL, sm_FMCO_RL);

    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_CC_IN1, sm_CCin1);
    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_CC_IN2, sm_CCin2);
    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_RECT_IN1, sm_RectIn1);
    pToN3DImgInfo->addImageBuffer(BID_P2AFM_OUT_RECT_IN2, sm_RectIn2);
...
TEST(DepthMapPipe_N3DNode, Standard)
{
    ...
    DepthNodeOpState state = eSTATE_NORMAL;
