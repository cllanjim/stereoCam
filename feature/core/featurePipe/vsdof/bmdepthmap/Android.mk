...
LOCAL_SRC_FILES += ./bufferPoolMgr/NodeBufferPoolMgr_Denoise.cpp
LOCAL_SRC_FILES += ./bufferPoolMgr/NodeBufferSizeMgr.cpp
LOCAL_SRC_FILES += ./bufferPoolMgr/NodeBufferHandler.cpp
## flow option
LOCAL_SRC_FILES += ./flowOption/DepthMapFlowOption_VSDOF.cpp
LOCAL_SRC_FILES += ./flowOption/DepthMapFlowOption_Denoise.cpp
## nodes
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/feature/core/featurePipe/vsdof/depthmap
################################################################################
...
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/hardware/mtkcam/drv/src/isp/$(PLATFORM)/iopipe/test
##
...
#LOCAL_CFLAGS += -DGTEST
################################################################################
LOCAL_MODULE := libmtkcam.featurepipe.bmdepthmap
