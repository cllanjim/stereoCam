...
*
********************************************************************************/
MINT32 halAUTORAMA::mHalAutoramaInit(MTKPipeAutoramaEnvInfo AutoramaInitInData, MTKPipeMotionEnvInfo MotionInitInfo)
{
    ...
    mpHal3A = MAKE_Hal3A(sensorIdx, "MTKPanorama");
...
)
{
    ...
    MHAL_LOGD("[mHalAutoramaDoMotion] ImgAddr 0x%p\n",(void*)MotionInfo.ImgAddr);
 ...
 *
 ******************************************************************************/
void halAUTORAMA::doNotifyCb(MINT32  _msgType,MINTPTR _ext1,MINTPTR _ext2,MINTPTR /*_ext3*/)
{
    MHAL_LOGD("halAUTORAMA doNotifyCb(%d) %p %p", _msgType, (void*)_ext1, (void*)_ext2);
