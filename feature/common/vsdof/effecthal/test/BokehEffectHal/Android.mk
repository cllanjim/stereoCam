...
LOCAL_SRC_FILES += BokehEffectHalUT.cpp
LOCAL_SRC_FILES += CaptureFrameGenerator.cpp
LOCAL_SRC_FILES += FrameGeneratorFactory.cpp
LOCAL_SRC_FILES += IFrameGeneratorBase.cpp
LOCAL_SRC_FILES += PreviewFrameGenerator.cpp
LOCAL_SRC_FILES += RecordFrameGenerator.cpp
LOCAL_SRC_FILES += Suite_BokehEffectHal.cpp
endif
#-----------------------------------------------------------
