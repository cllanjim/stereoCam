...
#LOCAL_SRC_FILES += Suite_TestDepthMapEffectHal_VSDOF.cpp
LOCAL_SRC_FILES += Suite_TestDepthMapEffectHal_Denoise.cpp
LOCAL_SRC_FILES += TestDepthMap_Common.cpp
################################################################################
################################################################################
...
LOCAL_CFLAGS += -DGTEST
################################################################################
LOCAL_MODULE := effectHALTest.bmdepthmap
