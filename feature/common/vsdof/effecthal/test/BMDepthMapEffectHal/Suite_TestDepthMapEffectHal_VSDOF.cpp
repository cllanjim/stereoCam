...
sp<IDepthMapEffectRequest> generateEffectRequest(int request_id, DepthMapPipeOpState eState)
{
    ...
    if(eState == eSTATE_CAPTURE)
    {
        ...
        pEffectReq->pushRequestImageBuffer({BID_P2AFM_OUT_MV_F_CAP, eBUFFER_IOTYPE_OUTPUT},buf);
    }
    else
    {
        ...
        pEffectReq->pushRequestImageBuffer({BID_P2AFM_OUT_MV_F, eBUFFER_IOTYPE_OUTPUT},buf);
    }
    ...
    if(USE_FD)
    {
        ...
        pEffectReq->pushRequestImageBuffer({BID_P2AFM_OUT_FDIMG, eBUFFER_IOTYPE_OUTPUT},buf);
    }
    ...
    pEffectReq->pushRequestImageBuffer({BID_OCC_OUT_MY_S, eBUFFER_IOTYPE_OUTPUT},buf);
    ...
    pEffectReq->pushRequestImageBuffer({BID_WMF_OUT_DMW, eBUFFER_IOTYPE_OUTPUT},buf);
...
TEST(DepthMapEffectHalTest, Standard)
{
    ...
    effParam->set(EFFECTKEY_SENSOR_STATE, (int)eSENSOR_BAYER_BAYER);
    ...
    {
        sp<IDepthMapEffectRequest> pEffReq = generateEffectRequest(i, eSTATE_NORMAL);
