...
#-----------------------------------------------------------
LOCAL_SRC_FILES += cfb_hal_base.cpp
LOCAL_SRC_FILES += cfb_hal.cpp

#-----------------------------------------------------------
#LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/include/mtkcam/algorithm/libfb
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/include/algorithm/$(shell echo $(MTK_PLATFORM) | tr A-Z a-z )/libfb
