...
#include <drv/tuning_mgr.h> //SL#include <mtkcam/featureio/tuning_mgr.h> //SL
...
//    android_atomic_inc(&mUsers);
    ...
    {
       pTuningQueBufAddrbymalloc[i]=(MINT8*)malloc(sizeof(dip_x_reg_t));
       memset((MUINT8*)(pTuningQueBufAddrbymalloc[i]), 0x0,sizeof(dip_x_reg_t));
...
//    color setting>>
    ...
    ppIspPhyRegLocal->DIP_X_G2G_CNV_1.Raw = 0x00000200;
    ppIspPhyRegLocal->DIP_X_G2G_CNV_2.Raw = 0x000002CE;
    ppIspPhyRegLocal->DIP_X_G2G_CNV_3.Raw = 0x1F500200;
    ppIspPhyRegLocal->DIP_X_G2G_CNV_4.Raw = 0x00001E92;
    ppIspPhyRegLocal->DIP_X_G2G_CNV_5.Raw = 0x038B0200;
    ppIspPhyRegLocal->DIP_X_G2G_CNV_6.Raw = 0x00000000;
    ppIspPhyRegLocal->DIP_X_G2G_CTRL.Raw = 0x00000009;
        //G2C
    ppIspPhyRegLocal->DIP_X_CTL_YUV_EN.Bits.G2C_EN=1;
    ppIspPhyRegLocal->DIP_X_G2C_CONV_0A.Raw=g2c.conv_0a.val;
    ppIspPhyRegLocal->DIP_X_G2C_CONV_0B.Raw=g2c.conv_0b.val;
    ppIspPhyRegLocal->DIP_X_G2C_CONV_1A.Raw=g2c.conv_1a.val;
    ppIspPhyRegLocal->DIP_X_G2C_CONV_1B.Raw=g2c.conv_1b.val;
    ppIspPhyRegLocal->DIP_X_G2C_CONV_2A.Raw=g2c.conv_2a.val;
    ppIspPhyRegLocal->DIP_X_G2C_CONV_2B.Raw=g2c.conv_2b.val;
...
*/
    ppIspPhyRegLocal->DIP_X_G2C_SHADE_CON_1.Raw=g2c_shade.set[0];
    ppIspPhyRegLocal->DIP_X_G2C_SHADE_CON_2.Raw=g2c_shade.set[1];
    ppIspPhyRegLocal->DIP_X_G2C_SHADE_CON_3.Raw=g2c_shade.set[2];
    ppIspPhyRegLocal->DIP_X_G2C_SHADE_TAR.Raw=0;// for TC's requests g2c_shade.tar.val;
    ppIspPhyRegLocal->DIP_X_G2C_SHADE_SP.Raw=g2c_shade.set[4];
    if(bRegDumpEnable)//if(bAddrDumpEnable)
    {
        if(m_eIdx_Effect==MTK_CONTROL_EFFECT_MODE_LOFI)
        {
            MY_LOG("LOFI eIdx_Effect(%d)SET - DIP_X_G2C_SHADE_CON_1.Raw 0x%8x",eIdx_Effect,ppIspPhyRegLocal->DIP_X_G2C_SHADE_CON_1.Raw);
            MY_LOG("LOFI  eIdx_Effect(%d)SET - DIP_X_G2C_SHADE_CON_2.Raw 0x%8x",eIdx_Effect,ppIspPhyRegLocal->DIP_X_G2C_SHADE_CON_2.Raw);
            MY_LOG("LOFI  eIdx_Effect(%d)SET - DIP_X_G2C_SHADE_CON_3.Raw 0x%8x",eIdx_Effect,ppIspPhyRegLocal->DIP_X_G2C_SHADE_CON_3.Raw);
            MY_LOG("LOFI  eIdx_Effect(%d)SET - DIP_X_G2C_SHADE_TAR.Raw 0x%8x",eIdx_Effect,ppIspPhyRegLocal->DIP_X_G2C_SHADE_TAR.Raw);
            MY_LOG("LOFI  eIdx_Effect(%d)SET - DIP_X_G2C_SHADE_SP.Raw 0x%8x",eIdx_Effect,ppIspPhyRegLocal->DIP_X_G2C_SHADE_SP.Raw);
        }
    }
    //SEEE
    ppIspPhyRegLocal->DIP_X_CTL_YUV_EN.Bits.SEEE_EN=1;
    ppIspPhyRegLocal->DIP_X_SEEE_OUT_EDGE_CTRL.Raw =  se.edge_ctrl.val;
    ppIspPhyRegLocal->DIP_X_SEEE_SE_Y_CTRL.Raw =  se.y_ctrl.val;
    ppIspPhyRegLocal->DIP_X_SEEE_SE_EDGE_CTRL_1.Raw =  se.edge_ctrl_1.val;
    ppIspPhyRegLocal->DIP_X_SEEE_SE_EDGE_CTRL_2.Raw =  se.edge_ctrl_2.val;
    ppIspPhyRegLocal->DIP_X_SEEE_SE_EDGE_CTRL_3.Raw =  se.edge_ctrl_3.val;
    ppIspPhyRegLocal->DIP_X_SEEE_SE_SPECL_CTRL.Raw =  se.special_ctrl.val;
    ppIspPhyRegLocal->DIP_X_SEEE_SE_CORE_CTRL_1.Raw =  se.core_ctrl_1.val;
    ppIspPhyRegLocal->DIP_X_SEEE_SE_CORE_CTRL_2.Raw =  se.core_ctrl_2.val;
    ...
    switch ((EIndex_Effect_T)eIdx_Effect)
    {
        ...
        case MTK_CONTROL_EFFECT_MODE_F1977 :
            ...
            {
                ppIspPhyRegLocal->DIP_X_GGM_LUT_RB[idx].Raw=LomoFilterGGMJni[(MUINT32)eIdx_Effect-(MUINT32)MTK_CONTROL_EFFECT_MODE_NASHVILLE+1][CUSTOM_LOMO_GGM_CHANNEL_BR][idx];
                ppIspPhyRegLocal->DIP_X_GGM_LUT_G[idx].Raw=LomoFilterGGMJni[(MUINT32)eIdx_Effect-(MUINT32)MTK_CONTROL_EFFECT_MODE_NASHVILLE+1][CUSTOM_LOMO_GGM_CHANNEL_G][idx];
            }
        ...
        default:
            ...
            for(int idx=0; idx<CUSTOM_LOMO_GGM_GAIN_NUM;idx++)
            {
                ppIspPhyRegLocal->DIP_X_GGM_LUT_RB[idx].Raw=LomoFilterGGMJni[0][CUSTOM_LOMO_GGM_CHANNEL_BR][idx];
                ppIspPhyRegLocal->DIP_X_GGM_LUT_G[idx].Raw=LomoFilterGGMJni[0][CUSTOM_LOMO_GGM_CHANNEL_G][idx];
            }
            break;
    }
...
MVOID LocalLomoDequeCallBack(QParams& rParams)
{
    ...
    LomoTimer ldequeTmr("lomo->deque_CB",rParams.mvOut.size(),1);
    ...
    for(MUINT32 Number=0; Number<LOMO_EFFECT_DST_BUFF_NUM; Number++)
    {
        ...
        {
            //LomoTimer lDstFlushTmr("DstFlush_CB",Number,0);
            //pBufDstHeap[Number].get()->syncCache(eCACHECTRL_INVALID);
...
MINT32 LomoHalJniImp::LomoImageEnque(MUINT8** ppDstImgVA, MINT32 ppEffectIdx)
{
    ...
    LomoTimer lenqueTmr("lomo->enque",ppEffectIdx,0);
...
//    LomoApplyTuningSetting(ppEffectIdx/*1*/, (void *)pTuningQueBufAddrbymalloc[EffectTuningBuffIdx]);
    params.mvTuningData.push_back(reinterpret_cast<MVOID*>(pTuningQueBufAddrbymalloc[EffectTuningBuffIdx]));

#ifdef LOMO_P2_DEQUE_CALLBACK
    params.mpfnCallback  = LocalLomoDequeCallBack;
#endif

    lenqueTmr.start("lomo->enque",ppEffectIdx,1);
...
MINT32 LomoHalJniImp::LomoImageDeque(MUINT8** ppDstImgMVA, MINT32 ppEffectIdx)
{
    ...
    if(ppEffectIdx!=(-1))//0xFFFFFFFF)
    {
        LomoTimer ldequeTmr("lomo->deque_AP",ppEffectIdx,0);

        ///deque
        ldequeTmr.start("lomo->deque_AP",ppEffectIdx,1);
        LOMO_TRACE_CALL();
