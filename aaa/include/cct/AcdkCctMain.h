...
#ifndef _ACDKCCTMAIN_H_
#define _ACDKCCTMAIN_H_
...
#include <mtkcam/utils/exif/CamExif.h>
#include <mtkcam/drv/IHalSensor.h>

#include <AcdkCctMhalBase.h>

using NSCamShot::CamShotDataInfo;
using NSCamShot::ISingleShot;
...
namespace NSACDK
{
     ...
     */
    typedef struct SensorRawImageInfo_s {
        MUINT32 u4Width;
        MUINT32 u4Height;
        MUINT32 u4BitDepth;
        MUINT32 u4IsPacked;
        MUINT32 u4Size;
        MUINT32 u4Order;
    } SensorRawImageInfo_t;

    /**
     *@struct acdkMainSensorInfo_s
     *@brief  Used for store sensor infomation
     */
    typedef struct MainSensorInfo_s
    {
        MINT32 facing;
        MINT32 devType;
    }MainSensorInfo_t;
    ...
    typedef enum
    {
        ACDK_CCT_MAIN_NONE           = 0x0000,
        ACDK_CCT_MAIN_INIT           = 0x0001,
        ACDK_CCT_MAIN_IDLE           = 0x0002,
        //
        ACDK_CCT_MAIN_PREVIEW_MASK   = 0x0100,
        ACDK_CCT_MAIN_PREVIEW        = 0x0100,
        //
        ACDK_CCT_MAIN_CAPTURE_MASK   = 0x0200,
        ACDK_CCT_MAIN_CAPTURE        = 0x0201,
        //
        ACDK_CCT_MAIN_UNINIT         = 0x0400,
        //
        ACDK_CCT_MAIN_ERROR          = 0x8000
    } AcdkCctMainState_e;
    ...
    /**
      ...
      */
    class AcdkCctMain : public AcdkCctBase
    {
    public:

        /**
         *@brief AcdkCctMain constructor
         */
        AcdkCctMain (ACDK_CCT_BYPASS_FLAG bypassFlag = ACDK_CCT_BYPASS_NONE);

        /**
         *@brief Destroy AcdkCctMain object
         */
         ...
         *@param[in] prvCb : preview callback function
         *
         *@param[in] mode : preview sensor mode
         *
         *@return
         *-0 indicates success, otherwise indicates fail
         */
        virtual MINT32 startPreview_CameraDev(Func_CB prvCb, MUINT32 const mode = 0 );
    ...
    private:
               ...
               /**
                *@brief Set current sate of AcdkCctMain to newState
                *
                *@param[in] newState : new state
                */
        virtual MVOID acdkCctMainSetState(AcdkCctMainState_e newState);

               /**
                *@brief Get current sate of AcdkCctMain
                */
        virtual AcdkCctMainState_e acdkCctMainGetState();

               /**
                *@brief Check state to avoid wrong command from user
                */
        virtual MINT32 stateMgr(AcdkCctMainState_e nextState);
  ...
  void setScenario(MUINT32 const mode, MUINT32 &DestScenario);
        ...
        AcdkCctMhalBase *m_pAcdkCctMhalObj;
        AcdkCctMhalBase *m_pAcdkCctMhalObjEng;
        AcdkUtility *m_pAcdkUtilityObj;

        mutable android::Mutex mLock;

        // state
        AcdkCctMainState_e m_eAcdkCctMainState;
        ...
        SensorRawImageInfo_t mSensorFormatInfo;  // Although name is RawImageInfo, but can get both raw/yuv type
