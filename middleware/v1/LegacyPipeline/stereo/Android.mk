...
$(info building LegacyPipeline/stereo ...)
################################################################################
#
################################################################################
...
#-----------------------------------------------------------
LOCAL_SRC_FILES += StereoLegacyPipelineBuilder.cpp
LOCAL_SRC_FILES += StereoLegacyPipeline.cpp
LOCAL_SRC_FILES += buffer/StereoSelector.cpp
LOCAL_SRC_FILES += buffer/StereoBufferSynchronizer.cpp
LOCAL_SRC_FILES += buffer/StereoBufferPoolImp.cpp
#-----------------------------------------------------------
...
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/hardware/dpframework/include
...
#-----------------------------------------------------------
LOCAL_MODULE := libcam.legacypipeline.stereo
