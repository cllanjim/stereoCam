...
#-----------------------------------------------------------
LOCAL_SRC_FILES += OTBufMgr.cpp
LOCAL_SRC_FILES += OTClient.BufOps.cpp
LOCAL_SRC_FILES += OTClient.Scenario.cpp
LOCAL_SRC_FILES += OTClient.Thread.cpp
LOCAL_SRC_FILES += OTClient.cpp
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/include/mtkcam/feature/ObjectTracking
