...
#-----------------------------------------------------------
LOCAL_SRC_FILES += default/Cam3DeviceImp.cpp
#
ifeq ($(MTK_CROSSMOUNT_SUPPORT),yes)
LOCAL_SRC_FILES += external/Cam3ExternalDeviceImp.cpp
endif
...
#-----------------------------------------------------------
LOCAL_WHOLE_STATIC_LIBRARIES += libcam.device3.common
#
...
LOCAL_SHARED_LIBRARIES += libcam3_app
