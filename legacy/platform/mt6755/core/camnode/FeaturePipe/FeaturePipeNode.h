...
#define SCHED_PRIORITY                  (ANDROID_PRIORITY_FOREGROUND)
...
#define FULL_IMAGE_MAX_HEIGHT           1306     //(1080 * 6 / 5)  , this is for EIS limitation

#define FULL_GPU_MAX_OUTPUT_WIDTH   2304 //For GIS debug use more than 20% of 1920
#define FULL_GPU_MAX_OUTPUT_HEIGHT  1306 //For GIS debug use more than 20% of 1088
