...
{    public:
    ...
    public://
		...
		static MINT32 cam_isp_nsl2_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage);
		...
		static MINT32 cam_isp_nbc2_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage);
        ...
        static MINT32 cam_isp_nsl2a_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage);
		static MINT32 cam_isp_nsl2b_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage);
		...
		static MINT32 cam_isp_udm_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage);
		...
		static MINT32 cam_isp_dbs_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage);
		...
		static MINT32 cam_isp_rwb_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage);	// add for rwb sensor
		static MINT32 cam_isp_iso_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage);	// add for ISO adaptive
        //
...
/////////////////////////////////////////////////////////////////////////////*/
#define CHECK_TUNING_P1_EN_BITS       6 //5
#define CHECK_TUNING_P2_EN_BITS       23 //19	// add for RWB sensor	// add for ISO adaptive
...
#define TUNING_SCENARIO_IP_EN_P1_TAG    0x000000F0
 ...
 ={  {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x03037856, 0x00000000 },  // ISP_SUB_MODE_RAW
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x03037A76, 0x00000000 },  // ISP_SUB_MODE_YUV
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x03037856, 0x00000000 },  // ISP_SUB_MODE_RGB
 ...
 ={  {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x0303FAFE, 0x00000000 },  // ISP_SUB_MODE_RAW
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x0303FAFE, 0x00000000 },  // ISP_SUB_MODE_YUV
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x0303FAFE, 0x00000000 },  // ISP_SUB_MODE_RGB
     {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 },  // ISP_SUB_MODE_JPG
 };

 const IspTopEnTable gIspTurningTopTag_fb[ISP_SUB_MODE_MAX]  //CFA,G2G,G2C,MFB,NR3D, LCE & LCEI be controled by imagaio path
 ={  {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x03033856, 0x00000000 },  // ISP_SUB_MODE_RAW
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x03033A76, 0x00000000 },  // ISP_SUB_MODE_YUV
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x03033856, 0x00000000 },  // ISP_SUB_MODE_RGB
     {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 },  // ISP_SUB_MODE_JPG
 };

 const IspTopEnTable gIspTurningFieldTag_fb[ISP_SUB_MODE_MAX] //LCE & LCEI be controled by imagaio path
 ={  {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x0303BAFE, 0x00000000 },  // ISP_SUB_MODE_RAW
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x0303BAFE, 0x00000000 },  // ISP_SUB_MODE_YUV
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x0303BAFE, 0x00000000 },  // ISP_SUB_MODE_RGB
     {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 },  // ISP_SUB_MODE_JPG
 };
 ...
 ={  {0x010000F0, 0x000000C0, 0x01000070, 0x000000C0, 0x03037856, 0x00000020 },  // ISP_SUB_MODE_RAW
     {0x010000F0, 0x000000C0, 0x01000070, 0x000000C0, 0x03037876, 0x00000020 },  // ISP_SUB_MODE_YUV
     {0x010000F0, 0x000000C0, 0x01000070, 0x000000C0, 0x03037856, 0x00000020 },  // ISP_SUB_MODE_RGB
     {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 },  // ISP_SUB_MODE_JPG
 };

 const IspTopEnTable gIspTurningFieldTag_ip[ISP_SUB_MODE_MAX]
 ={  {0x010000F0, 0x000000C0, 0x01000070, 0x000000C0, 0x0303FAFE, 0x00000020 },  // ISP_SUB_MODE_RAW
     {0x010000F0, 0x000000C0, 0x01000070, 0x000000C0, 0x0303FAFE, 0x00000020 },  // ISP_SUB_MODE_YUV
     {0x010000F0, 0x000000C0, 0x01000070, 0x000000C0, 0x0303FAFE, 0x00000020 },  // ISP_SUB_MODE_RGB
     {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 },  // ISP_SUB_MODE_JPG
 };


 const IspTopModuleMappingTable gIspModuleMappingTableP1En[CHECK_TUNING_P1_EN_BITS]
 ={ {CAM_CTL_EN_P1_DBS_EN, CAM_CTL_EN_P1_DMA_NONE_EN, eIspModuleRaw, eIspTuningMgrFunc_Dbs, eIspTuningMgrFunc_Null, CAM_ISP_DBS,  CAM_DUMMY_, CAM_DUMMY_,   IspDrv_B::cam_isp_dbs_cfg},
    ...
    {CAM_CTL_EN_P1_RMG_EN, CAM_CTL_EN_P1_DMA_NONE_EN, eIspModuleRaw, eIspTuningMgrFunc_Rmg, eIspTuningMgrFunc_Null, CAM_CTL_VHDR, CAM_DUMMY_, CAM_DUMMY_,   IspDrv_B::cam_isp_rmg_cfg},
  };
 ...
 ={ {CAM_CTL_EN_P2_UFD_EN , CAM_CTL_EN_P2_DMA_NONE_EN, eIspModuleRaw,  eIspTuningMgrFunc_Null,          eIspTuningMgrFunc_Null,     CAM_ISP_UFD,          CAM_DUMMY_,        CAM_DUMMY_,   NULL},
    ...
    {CAM_CTL_EN_P2_NSL2_EN , CAM_CTL_EN_P2_DMA_NONE_EN, eIspModuleRgb,  eIspTuningMgrFunc_Nsl2,           eIspTuningMgrFunc_Null,     CAM_ISP_NSL2,          CAM_DUMMY_,        CAM_DUMMY_,   IspDrv_B::cam_isp_nsl2_cfg},
    ...
    {CAM_CTL_EN_P2_UDM_EN , CAM_CTL_EN_P2_DMA_NONE_EN, eIspModuleRgb,  eIspTuningMgrFunc_Udm,           eIspTuningMgrFunc_Null,     CAM_ISP_UDM,          CAM_DUMMY_,        CAM_DUMMY_,   IspDrv_B::cam_isp_udm_cfg},
    ...
    {CAM_CTL_EN_P2_NBC_EN , CAM_CTL_EN_P2_DMA_NONE_EN, eIspModuleYuv,  eIspTuningMgrFunc_Nbc,           eIspTuningMgrFunc_Nbc_Tbl,  CAM_ISP_NBC,          CAM_ISP_NBC_TBL,   CAM_DUMMY_,   IspDrv_B::cam_isp_nbc_cfg},	// for ANR table
    ...
    {CAM_CTL_EN_P2_NSL2B_EN,CAM_CTL_EN_P2_DMA_NONE_EN, eIspModuleYuv,  eIspTuningMgrFunc_Nsl2b,         eIspTuningMgrFunc_Null,     CAM_ISP_NSL2B,        CAM_DUMMY_,        CAM_DUMMY_,   IspDrv_B::cam_isp_nsl2b_cfg},
    ...
    {CAM_CTL_EN_P2_NBC2_EN, CAM_CTL_EN_P2_DMA_NONE_EN, eIspModuleYuv,  eIspTuningMgrFunc_Nbc2,          eIspTuningMgrFunc_Null,     CAM_ISP_NBC2,         CAM_DUMMY_,        CAM_DUMMY_,   IspDrv_B::cam_isp_nbc2_cfg},
    {CAM_CTL_EN_P2_NSL2A_EN,CAM_CTL_EN_P2_DMA_NONE_EN, eIspModuleYuv,  eIspTuningMgrFunc_Nsl2a,         eIspTuningMgrFunc_Null,     CAM_ISP_NSL2A,        CAM_DUMMY_,        CAM_DUMMY_,   IspDrv_B::cam_isp_nsl2a_cfg},
    {CAM_CTL_EN_P2_UFD_EN , CAM_CTL_EN_P2_DMA_NONE_EN, eIspModuleYuv,  eIspTuningMgrFunc_Rwb,           eIspTuningMgrFunc_Null,     CAM_ISP_RWB,       	  CAM_DUMMY_,        CAM_DUMMY_,   IspDrv_B::cam_isp_rwb_cfg},	// add for RWB sensor
    {CAM_CTL_EN_P2_UFD_EN , CAM_CTL_EN_P2_DMA_NONE_EN, eIspModuleYuv,  eIspTuningMgrFunc_Iso,           eIspTuningMgrFunc_Null,     CAM_ISP_ISO,       	  CAM_DUMMY_,        CAM_DUMMY_,   IspDrv_B::cam_isp_iso_cfg},	// add for ISO adaptive
 };
...
public:
    IspFunction_B(): m_Reg_Base_Addr(0),bypass(0),m_pP1IspDrvD(NULL),m_pP1CurCQDIspReg(NULL),m_twin_sdnumX(0),m_twin_lblkW(0){};
...
public:
    DMAO_B():dupCqIdx(0),burstQueIdx(0),CQ(CAM_ISP_CQ_NONE),CQ_D(CAM_ISP_CQ_NONE),isTwinMode(MFALSE)
        {dma_cfg.pixel_byte = 1;};
...
public:
    ISP_TOP_CTRL():
        ...
        pathD(ISP_PASS_NONE),
        sub_mode(ISP_SUB_MODE_RAW),
        sub_mode_D(ISP_SUB_MODE_RAW)
        {
            ...
            b_continuous[1] = 0;
            b_continuous[2] = 0;
            isp_top_ctl.CAM_CTL_FMT_SEL_P1_MASK=0;
            isp_top_ctl.CAM_CTL_FMT_SEL_P1_D_MASK=0;
            isp_top_ctl.CAM_CTL_SEL_GLOBAL_MASK=0;
            isp_top_ctl.CAMSV_CAMSV_FMT_SEL_MASK=0;
            isp_top_ctl.CAMSV_CAMSV2_FMT_SEL_MASK=0;
            isp_top_ctl.CAMSV_CAMSV_PAK_MASK=0;
            isp_top_ctl.CAMSV_CAMSV2_PAK_MASK=0;
         };
...
public:
    ...
    isp_reg_t *pTuningIspReg;  // p2 tuning data set by tuning provider
public:
    ISP_YUV_PIPE():en_p2(0),magicNum(0),dupCqIdx(0),burstQueIdx(0),drvScenario(0),sub_mode(0),CQ(CAM_ISP_CQ_NONE),isV3(MFALSE),isApplyTuning(MFALSE),sl2cCrzRatio(1.0),lceInputW(0),lceInputH(0),fe_ctrl(0x0),pTuningIspReg(NULL),rrzRatio(1.0),rrzCropX(0),rrzCropY(0)
    {};
    ~ISP_YUV_PIPE(){};
...
struct stISP_BUF_INFO
{
    ...
    , m_num_0(0)
    , m_num_1(0)
    , raw_type(ISP_RROCESSED_RAW)
    , frm_cnt(0)
    , header_info(NULL)
    , header_size(0)
    , mBufIdx(0)
    {
        memset(&rrz_info, 0, sizeof(rrz_info));
        memset(&dma_crop, 0, sizeof(dma_crop));
    }
};
...
public:
    ISP_BUF_CTRL():path(0),drvScenario(-1),dequeCq(CAM_ISP_CQ_NONE),dequeDupCqIdx(0),dequeBurstQueIdx(0),CQ(CAM_ISP_CQ_NONE),CQ_D(CAM_ISP_CQ_NONE),path_D(ISP_PASS_NONE),dupCqIdx(0),burstQueIdx(0),pPass1Ctrl(NULL)
