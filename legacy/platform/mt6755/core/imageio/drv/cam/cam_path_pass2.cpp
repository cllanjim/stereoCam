...
//    cdpPipe.conf_cdrz = 0;
    ...
    if ( p_parameter->tpipe == CAM_MODE_TPIPE ) {
        ...
        ispMdpPipe.isoValue = p_parameter->isoValue;	// set ISO
    } else {
	...
	ISP_PATH_DBG("set iso: CamPathPass2Parameter(%d), ISP_MDP_PIPE(%d)", p_parameter->isoValue, ispMdpPipe.isoValue);
...
int CamPathPass2::configTpipeData( struct CamPathPass2Parameter* p_parameter )
{
    ...
    tdriPipe.tdri.top.nsl2_en = pP2En->Bits.NSL2_EN;
    //tdriPipe.tdri.top.cfa_en = pP2En->Bits.CFA_EN;
    tdriPipe.tdri.top.udm_en = pP2En->Bits.UDM_EN;
    ...
    tdriPipe.tdri.top.nsl2a_en = pP2En->Bits.NSL2A_EN;
    tdriPipe.tdri.top.nsl2b_en = pP2En->Bits.NSL2B_EN;
    tdriPipe.tdri.top.nbc_en = pP2En->Bits.NBC_EN;
	tdriPipe.tdri.top.nbc2_en = pP2En->Bits.NBC2_EN;
    ...
    if(p_parameter->isV3 == MTRUE)
    {
        if(p_parameter->isApplyTuning==MTRUE)
        {
            ...
            tdriPipe.tdri.tuningFunc.nbc.anr1_eny = p_parameter->pTuningIspReg->CAM_ANR_CON1.Bits.ANR1_ENY;
            tdriPipe.tdri.tuningFunc.nbc.anr1_enc = p_parameter->pTuningIspReg->CAM_ANR_CON1.Bits.ANR1_ENC;
            tdriPipe.tdri.tuningFunc.nbc.anr1_iir_mode = 0;
            tdriPipe.tdri.tuningFunc.nbc.anr1_scale_mode = p_parameter->pTuningIspReg->CAM_ANR_CON1.Bits.ANR1_SCALE_MODE;
            //nbc2
            tdriPipe.tdri.tuningFunc.nbc2.anr2_eny = p_parameter->pTuningIspReg->CAM_ANR2_CON1.Bits.ANR2_ENY;
            tdriPipe.tdri.tuningFunc.nbc2.anr2_enc = p_parameter->pTuningIspReg->CAM_ANR2_CON1.Bits.ANR2_ENC;
            tdriPipe.tdri.tuningFunc.nbc2.anr2_scale_mode = p_parameter->pTuningIspReg->CAM_ANR2_CON1.Bits.ANR2_SCALE_MODE;
            //seee
            ...
            tdriPipe.tdri.tuningFunc.udm.bayer_bypass = p_parameter->pTuningIspReg->CAM_UDM_INTP_CRS.Bits.UDM_BYP;//p_parameter->pTuningIspReg->CAM_CFA;//p_parameter->cfa.bayer_bypass;
            //sl2
            ...
            tdriPipe.tdri.tuningFunc.nsl2.nsl2_hrz_comp = p_parameter->pTuningIspReg->CAM_NSL2_RZ.Bits.SL2_HRZ_COMP;
            tdriPipe.tdri.tuningFunc.nsl2.nsl2_vrz_comp = p_parameter->pTuningIspReg->CAM_NSL2_RZ.Bits.SL2_VRZ_COMP;
            tdriPipe.tdri.tuningFunc.nsl2a.nsl2a_hrz_comp = p_parameter->pTuningIspReg->CAM_NSL2_RZ.Bits.SL2_HRZ_COMP;
            tdriPipe.tdri.tuningFunc.nsl2a.nsl2a_vrz_comp = p_parameter->pTuningIspReg->CAM_NSL2_RZ.Bits.SL2_VRZ_COMP;
            tdriPipe.tdri.tuningFunc.nsl2b.nsl2b_hrz_comp = p_parameter->pTuningIspReg->CAM_NSL2_RZ.Bits.SL2_HRZ_COMP;
            tdriPipe.tdri.tuningFunc.nsl2b.nsl2b_vrz_comp = p_parameter->pTuningIspReg->CAM_NSL2_RZ.Bits.SL2_VRZ_COMP;
            tdriPipe.tdri.tuningFunc.sl2c.sl2c_hrz_comp = p_parameter->pTuningIspReg->CAM_NSL2_RZ.Bits.SL2_HRZ_COMP;
        }
    }
    else
    {
	...
	::memset( (char*)&tdriPipe.tdri.tuningFunc.nsl2, 0x0, sizeof(ISP_TPIPE_CONFIG_NSL2_STRUCT));
	...
	::memset( (char*)&tdriPipe.tdri.tuningFunc.nbc2, 0x0, sizeof(ISP_TPIPE_CONFIG_NBC2_STRUCT));
    ...
    ::memset( (char*)&tdriPipe.tdri.tuningFunc.nsl2a, 0x0, sizeof(ISP_TPIPE_CONFIG_NSL2A_STRUCT));
    ::memset( (char*)&tdriPipe.tdri.tuningFunc.nsl2b, 0x0, sizeof(ISP_TPIPE_CONFIG_NSL2B_STRUCT));
    ...
    tdriPipe.tdri.tuningFunc.udm.bayer_bypass = 0;
