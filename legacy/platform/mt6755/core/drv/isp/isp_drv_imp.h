...
class IspDrvImp : public IspDrv
{
    ...
    public:
        ...
        virtual MBOOL   enqueP2Frame(MUINT32 callerID,MINT32 p2burstQIdx,MINT32 p2dupCQIdx,MINT32 frameNum);
...
class IspDrvVirImp : public IspDrv
{
    ...
    static IspDrv*  getInstance(MINT32 cq, MUINT32* ispVirRegAddr,isp_reg_t* ispVirRegMap);
        virtual void    destroyInstance(void);
        virtual MINT32 isp_fd_open(const char* userName=""){/*LOG_ERR("Not support");*/return MTRUE;}
        virtual MINT32 isp_fd_close(MINT32 mIspFd){/*LOG_ERR("Not support");*/return MTRUE;}
    ...
    virtual MBOOL checkCQBufAllocated(void){/*LOG_ERR("Not support");*/return MTRUE;}
        ...
        virtual MUINT64 getTuningUpdateFuncBit(ETuningQueAccessPath ePath, MINT32 magicNum, MINT32 cq,MUINT32 drvScenario){return eIspTuningMgrFunc_Null;};
        ...
        //
        // dequeue mechanism in ihalpipewarpper
        virtual MBOOL   enqueP2Frame(MUINT32 callerID,MINT32 p2burstQIdx,MINT32 p2dupCQIdx,MINT32 frameNum) {return MFALSE;};
