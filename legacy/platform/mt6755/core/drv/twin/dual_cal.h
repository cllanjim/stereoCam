...
#define DUAL_SW_LUT(CMD, a, b, c, d, e, f) \
	...
	/* RAWI */\
	CMD(a, b, c, d, e, f, int, TWIN_RAWI_XSIZE, 0x2, TWIN_RAWI_XSIZE, R, SW, TWIN_RAWI_XSIZE)\
...
#define DUAL_HW_LUT(CMD, a, b, c, d, e, f) \
	...
	CMD(a, b, c, d, e, f, int, BIN_SEL, 0x4, CAM_CTL_SEL_GLOBAL.BIN_SEL, R, CAM_CTL_SEL_GLOBAL, BIN_SEL)\
	...
	/* DBS */\
    CMD(a, b, c, d, e, f, int, DBS_EN, 0x4, CAM_CTL_EN_P1.DBS_EN, R, CAM_CTL_EN_P1, DBS_EN)\
    CMD(a, b, c, d, e, f, int, DBS_OFST, 0x4, CAM_DBS_SIGMA.DBS_OFST, R, CAM_DBS_SIGMA, DBS_OFST)\
    CMD(a, b, c, d, e, f, int, DBS_SL, 0x4, CAM_DBS_SIGMA.DBS_SL, R, CAM_DBS_SIGMA, DBS_SL)\
    CMD(a, b, c, d, e, f, int, DBS_MUL, 0x4, CAM_DBS_SIGMA.DBS_MUL, R, CAM_DBS_SIGMA, DBS_MUL)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y0, 0x4, CAM_DBS_BSTBL_0.DBS_BIAS_Y0, R, CAM_DBS_BSTBL_0, DBS_BIAS_Y0)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y1, 0x4, CAM_DBS_BSTBL_0.DBS_BIAS_Y1, R, CAM_DBS_BSTBL_0, DBS_BIAS_Y1)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y2, 0x4, CAM_DBS_BSTBL_0.DBS_BIAS_Y2, R, CAM_DBS_BSTBL_0, DBS_BIAS_Y2)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y3, 0x4, CAM_DBS_BSTBL_0.DBS_BIAS_Y3, R, CAM_DBS_BSTBL_0, DBS_BIAS_Y3)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y4, 0x4, CAM_DBS_BSTBL_1.DBS_BIAS_Y4, R, CAM_DBS_BSTBL_1, DBS_BIAS_Y4)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y5, 0x4, CAM_DBS_BSTBL_1.DBS_BIAS_Y5, R, CAM_DBS_BSTBL_1, DBS_BIAS_Y5)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y6, 0x4, CAM_DBS_BSTBL_1.DBS_BIAS_Y6, R, CAM_DBS_BSTBL_1, DBS_BIAS_Y6)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y7, 0x4, CAM_DBS_BSTBL_1.DBS_BIAS_Y7, R, CAM_DBS_BSTBL_1, DBS_BIAS_Y7)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y8, 0x4, CAM_DBS_BSTBL_2.DBS_BIAS_Y8, R, CAM_DBS_BSTBL_2, DBS_BIAS_Y8)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y9, 0x4, CAM_DBS_BSTBL_2.DBS_BIAS_Y9, R, CAM_DBS_BSTBL_2, DBS_BIAS_Y9)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y10, 0x4, CAM_DBS_BSTBL_2.DBS_BIAS_Y10, R, CAM_DBS_BSTBL_2, DBS_BIAS_Y10)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y11, 0x4, CAM_DBS_BSTBL_2.DBS_BIAS_Y11, R, CAM_DBS_BSTBL_2, DBS_BIAS_Y11)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y12, 0x4, CAM_DBS_BSTBL_3.DBS_BIAS_Y12, R, CAM_DBS_BSTBL_3, DBS_BIAS_Y12)\
    CMD(a, b, c, d, e, f, int, DBS_HDR_GNP, 0x4, CAM_DBS_CTL.DBS_HDR_GNP, R, CAM_DBS_CTL, DBS_HDR_GNP)\
    CMD(a, b, c, d, e, f, int, DBS_HDR_GAIN, 0x4, CAM_DBS_CTL.DBS_HDR_GAIN, R, CAM_DBS_CTL, DBS_HDR_GAIN)\
    CMD(a, b, c, d, e, f, int, DBS_HDR_GAIN2, 0x4, CAM_DBS_CTL.DBS_HDR_GAIN2, R, CAM_DBS_CTL, DBS_HDR_GAIN2)\
	/* DBS_D */\
    CMD(a, b, c, d, e, f, int, DBS_D_EN, 0x4, CAM_CTL_EN_P1_D.DBS_D_EN, W, CAM_CTL_EN_P1_D, DBS_D_EN)\
    CMD(a, b, c, d, e, f, int, DBS_D_LE_INV_CTL, 0x4, CAM_DBS_D_CTL.DBS_D_LE_INV_CTL, W, CAM_DBS_D_CTL, DBS_D_LE_INV_CTL)\
    CMD(a, b, c, d, e, f, int, DBS_D_OFST, 0x4, CAM_DBS_D_SIGMA.DBS_D_OFST, W, CAM_DBS_D_SIGMA, DBS_D_OFST)\
    CMD(a, b, c, d, e, f, int, DBS_D_SL, 0x4, CAM_DBS_D_SIGMA.DBS_D_SL, W, CAM_DBS_D_SIGMA, DBS_D_SL)\
    CMD(a, b, c, d, e, f, int, DBS_D_MUL, 0x4, CAM_DBS_D_SIGMA.DBS_D_MUL, W, CAM_DBS_D_SIGMA, DBS_D_MUL)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y0, 0x4, CAM_DBS_D_BSTBL_0.DBS_D_BIAS_Y0, W, CAM_DBS_D_BSTBL_0, DBS_D_BIAS_Y0)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y1, 0x4, CAM_DBS_D_BSTBL_0.DBS_D_BIAS_Y1, W, CAM_DBS_D_BSTBL_0, DBS_D_BIAS_Y1)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y2, 0x4, CAM_DBS_D_BSTBL_0.DBS_D_BIAS_Y2, W, CAM_DBS_D_BSTBL_0, DBS_D_BIAS_Y2)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y3, 0x4, CAM_DBS_D_BSTBL_0.DBS_D_BIAS_Y3, W, CAM_DBS_D_BSTBL_0, DBS_D_BIAS_Y3)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y4, 0x4, CAM_DBS_D_BSTBL_1.DBS_D_BIAS_Y4, W, CAM_DBS_D_BSTBL_1, DBS_D_BIAS_Y4)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y5, 0x4, CAM_DBS_D_BSTBL_1.DBS_D_BIAS_Y5, W, CAM_DBS_D_BSTBL_1, DBS_D_BIAS_Y5)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y6, 0x4, CAM_DBS_D_BSTBL_1.DBS_D_BIAS_Y6, W, CAM_DBS_D_BSTBL_1, DBS_D_BIAS_Y6)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y7, 0x4, CAM_DBS_D_BSTBL_1.DBS_D_BIAS_Y7, W, CAM_DBS_D_BSTBL_1, DBS_D_BIAS_Y7)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y8, 0x4, CAM_DBS_D_BSTBL_2.DBS_D_BIAS_Y8, W, CAM_DBS_D_BSTBL_2, DBS_D_BIAS_Y8)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y9, 0x4, CAM_DBS_D_BSTBL_2.DBS_D_BIAS_Y9, W, CAM_DBS_D_BSTBL_2, DBS_D_BIAS_Y9)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y10, 0x4, CAM_DBS_D_BSTBL_2.DBS_D_BIAS_Y10, W, CAM_DBS_D_BSTBL_2, DBS_D_BIAS_Y10)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y11, 0x4, CAM_DBS_D_BSTBL_2.DBS_D_BIAS_Y11, W, CAM_DBS_D_BSTBL_2, DBS_D_BIAS_Y11)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y12, 0x4, CAM_DBS_D_BSTBL_3.DBS_D_BIAS_Y12, W, CAM_DBS_D_BSTBL_3, DBS_D_BIAS_Y12)\
    CMD(a, b, c, d, e, f, int, DBS_D_HDR_GNP, 0x4, CAM_DBS_D_CTL.DBS_D_HDR_GNP, W, CAM_DBS_D_CTL, DBS_D_HDR_GNP)\
    CMD(a, b, c, d, e, f, int, DBS_D_HDR_GAIN, 0x4, CAM_DBS_D_CTL.DBS_D_HDR_GAIN, W, CAM_DBS_D_CTL, DBS_D_HDR_GAIN)\
    CMD(a, b, c, d, e, f, int, DBS_D_HDR_GAIN2, 0x4, CAM_DBS_D_CTL.DBS_D_HDR_GAIN2, W, CAM_DBS_D_CTL, DBS_D_HDR_GAIN2)\
    /* OBC */\
    ...
    CMD(a, b, c, d, e, f, int, BNR_D_LE_INV_CTL, 0x4, CAM_BPC_D_CON.BNR_LE_INV_CTL, W, CAM_BPC_D_CON, BNR_LE_INV_CTL)\
    ...
    /* RMM */\
    CMD(a, b, c, d, e, f, int, RMG_EN, 0x4, CAM_CTL_EN_P1.RMG_EN, R, CAM_CTL_EN_P1, RMG_EN)\
    CMD(a, b, c, d, e, f, int, RMG_IHDR_EN, 0x4, CAM_RMG_HDR_CFG.RMG_IHDR_EN, R, CAM_RMG_HDR_CFG, RMG_IHDR_EN)\
    CMD(a, b, c, d, e, f, int, RMG_IHDR_LE_FIRST, 0x4, CAM_RMG_HDR_CFG.RMG_IHDR_LE_FIRST, R, CAM_RMG_HDR_CFG, RMG_IHDR_LE_FIRST)\
    CMD(a, b, c, d, e, f, int, RMG_ZHDR_EN, 0x4, CAM_RMG_HDR_CFG.RMG_ZHDR_EN, R, CAM_RMG_HDR_CFG, RMG_ZHDR_EN)\
    CMD(a, b, c, d, e, f, int, RMG_ZHDR_RLE, 0x4, CAM_RMG_HDR_CFG.RMG_ZHDR_RLE, R, CAM_RMG_HDR_CFG, RMG_ZHDR_RLE)\
    CMD(a, b, c, d, e, f, int, RMG_ZHDR_GLE, 0x4, CAM_RMG_HDR_CFG.RMG_ZHDR_GLE, R, CAM_RMG_HDR_CFG, RMG_ZHDR_GLE)\
    CMD(a, b, c, d, e, f, int, RMG_ZHDR_BLE, 0x4, CAM_RMG_HDR_CFG.RMG_ZHDR_BLE, R, CAM_RMG_HDR_CFG, RMG_ZHDR_BLE)\
    CMD(a, b, c, d, e, f, int, RMG_HDR_TH, 0x4, CAM_RMG_HDR_CFG.RMG_HDR_TH, R, CAM_RMG_HDR_CFG, RMG_HDR_TH)\
    CMD(a, b, c, d, e, f, int, RMG_OSC_TH, 0x4, CAM_RMG_HDR_CFG.RMG_OSC_TH, R, CAM_RMG_HDR_CFG, RMG_OSC_TH)\
    CMD(a, b, c, d, e, f, int, RMG_HDR_GAIN, 0x4, CAM_RMG_HDR_GAIN.RMG_HDR_GAIN, R, CAM_RMG_HDR_GAIN, RMG_HDR_GAIN)\
    CMD(a, b, c, d, e, f, int, RMG_HDR_RATIO, 0x4, CAM_RMG_HDR_GAIN.RMG_HDR_RATIO, R, CAM_RMG_HDR_GAIN, RMG_HDR_RATIO)\
    /* RMM_D */\
    CMD(a, b, c, d, e, f, int, RMG_D_EN, 0x4, CAM_CTL_EN_P1_D.RMG_D_EN, W, CAM_CTL_EN_P1_D, RMG_D_EN)\
    CMD(a, b, c, d, e, f, int, RMG_D_IHDR_EN, 0x4, CAM_RMG_D_HDR_CFG.RMG_D_IHDR_EN, W, CAM_RMG_D_HDR_CFG, RMG_D_IHDR_EN)\
    CMD(a, b, c, d, e, f, int, RMG_D_IHDR_LE_FIRST, 0x4, CAM_RMG_D_HDR_CFG.RMG_D_IHDR_LE_FIRST, W, CAM_RMG_D_HDR_CFG, RMG_D_IHDR_LE_FIRST)\
    CMD(a, b, c, d, e, f, int, RMG_D_ZHDR_EN, 0x4, CAM_RMG_D_HDR_CFG.RMG_D_ZHDR_EN, W, CAM_RMG_D_HDR_CFG, RMG_D_ZHDR_EN)\
    CMD(a, b, c, d, e, f, int, RMG_D_ZHDR_RLE, 0x4, CAM_RMG_D_HDR_CFG.RMG_D_ZHDR_RLE, W, CAM_RMG_D_HDR_CFG, RMG_D_ZHDR_RLE)\
    CMD(a, b, c, d, e, f, int, RMG_D_ZHDR_GLE, 0x4, CAM_RMG_D_HDR_CFG.RMG_D_ZHDR_GLE, W, CAM_RMG_D_HDR_CFG, RMG_D_ZHDR_GLE)\
    CMD(a, b, c, d, e, f, int, RMG_D_ZHDR_BLE, 0x4, CAM_RMG_D_HDR_CFG.RMG_D_ZHDR_BLE, W, CAM_RMG_D_HDR_CFG, RMG_D_ZHDR_BLE)\
    CMD(a, b, c, d, e, f, int, RMG_D_HDR_TH, 0x4, CAM_RMG_D_HDR_CFG.RMG_D_HDR_TH, W, CAM_RMG_D_HDR_CFG, RMG_D_HDR_TH)\
    CMD(a, b, c, d, e, f, int, RMG_D_OSC_TH, 0x4, CAM_RMG_D_HDR_CFG.RMG_D_OSC_TH, W, CAM_RMG_D_HDR_CFG, RMG_D_OSC_TH)\
    CMD(a, b, c, d, e, f, int, RMG_D_HDR_GAIN, 0x4, CAM_RMG_D_HDR_GAIN.RMG_D_HDR_GAIN, W, CAM_RMG_D_HDR_GAIN, RMG_D_HDR_GAIN)\
    CMD(a, b, c, d, e, f, int, RMG_D_HDR_RATIO, 0x4, CAM_RMG_D_HDR_GAIN.RMG_D_HDR_RATIO, W, CAM_RMG_D_HDR_GAIN, RMG_D_HDR_RATIO)\
    CMD(a, b, c, d, e, f, int, RMG_D_LE_INV_CTL, 0x4, CAM_RMG_D_HDR_GAIN.RMG_D_LE_INV_CTL, W, CAM_RMG_D_HDR_GAIN, RMG_D_LE_INV_CTL)\
...
#define DUAL_WRITE_FILE_REMARK(a, b, c, d, e, f, g, h, i, j, k, l, m,...)  DUAL_WRITE_FILE_REMARK_##k(a, b, c, d, e, f, g, h, i, j, k, l, m,...)
#define DUAL_WRITE_FILE_REMARK_RW(a, b, c, d, e, f, g, h, i, j, k, l, m,...)  DUAL_WRITE_FILE_REMARK_W(a, b, c, d, e, f, g, h, i, j, k, l, m,...)
#define DUAL_WRITE_FILE_REMARK_R(a, b, c, d, e, f, g, h, i, j, k, l, m,...)
#define DUAL_WRITE_FILE_REMARK_W(a, b, c, d, e, f, g, h, i, j, k, l, m,...) \
	if (false == (a))\
	{\
		if ((b)->h != (d)->h)\
		{\
			if (0 == memcmp(e, #j, sizeof(#j)))\
			{\
				if (c)\
				{\
					fprintf(c, "#%s", f);\
