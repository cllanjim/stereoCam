...
static ISP_MESSAGE_ENUM dual_cal_rmg(const ISP_DUAL_IN_CONFIG_STRUCT *ptr_in_param, ISP_DUAL_OUT_CONFIG_STRUCT *ptr_out_param);
                               ...
                               ISP_DUAL_OUT_CONFIG_STRUCT *ptr_out_param)
{
    ...
    if (ptr_in_param && ptr_out_param)
    {
        ...
        if (ISP_MESSAGE_OK == result)
        {
			result = dual_cal_rmg(ptr_in_param, ptr_out_param);
        }
        if (ISP_MESSAGE_OK == result)
        {
...
static ISP_MESSAGE_ENUM dual_cal_dmx(const ISP_DUAL_IN_CONFIG_STRUCT *ptr_in_param, ISP_DUAL_OUT_CONFIG_STRUCT *ptr_out_param)
{
    ...
    if (ptr_in_param->CAM_CTL_SEL_GLOBAL.Bits.DUAL_MODE && ptr_in_param->CAM_CTL_EN_P1.Bits.BMX_EN &&
        ptr_in_param->CAM_CTL_EN_P1.Bits.RMX_EN && ptr_in_param->CAM_CTL_EN_P1.Bits.DMX_EN)
    {
		int bin_sel_h_size = (0 == ptr_in_param->CAM_CTL_SEL_GLOBAL.Bits.BIN_SEL)?
			(ptr_in_param->CAM_TG_SEN_GRAB_PXL.Bits.PXL_E - ptr_in_param->CAM_TG_SEN_GRAB_PXL.Bits.PXL_S):
        ...
        ptr_out_param->CAM_DMX_CROP.Bits.DMX_END_X = ((unsigned int)bin_sel_h_size>>1) + (((unsigned int)bin_sel_h_size>>1) & 0x1) +
			(ptr_in_param->CAM_CTL_EN_P1.Bits.DBS_EN?TILE_LOSS_DBS:0) +
...
static ISP_MESSAGE_ENUM dual_cal_dbs(const ISP_DUAL_IN_CONFIG_STRUCT *ptr_in_param, ISP_DUAL_OUT_CONFIG_STRUCT *ptr_out_param)
{
		...
		ptr_in_param->CAM_CTL_EN_P1.Bits.RMX_EN && ptr_in_param->CAM_CTL_EN_P1.Bits.DMX_EN)
	{
		...
		{
			if (ptr_out_param->CAM_DMX_D_CROP.Bits.DMX_STR_X & 0x3)
			{
				ptr_out_param->CAM_DBS_D_CTL.Bits.DBS_D_LE_INV_CTL = 0x2 + 0x8;/* 0x1: LE, 0x2: R, 0x4: G, 0x8: B */
			}
			/* update right by left */
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_SIGMA.Bits.DBS_OFST, CAM_DBS_D_SIGMA.Bits.DBS_D_OFST);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_SIGMA.Bits.DBS_SL, CAM_DBS_D_SIGMA.Bits.DBS_D_SL);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_SIGMA.Bits.DBS_MUL, CAM_DBS_D_SIGMA.Bits.DBS_D_MUL);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_0.Bits.DBS_BIAS_Y0, CAM_DBS_D_BSTBL_0.Bits.DBS_D_BIAS_Y0);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_0.Bits.DBS_BIAS_Y1, CAM_DBS_D_BSTBL_0.Bits.DBS_D_BIAS_Y1);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_0.Bits.DBS_BIAS_Y2, CAM_DBS_D_BSTBL_0.Bits.DBS_D_BIAS_Y2);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_0.Bits.DBS_BIAS_Y3, CAM_DBS_D_BSTBL_0.Bits.DBS_D_BIAS_Y3);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_1.Bits.DBS_BIAS_Y4, CAM_DBS_D_BSTBL_1.Bits.DBS_D_BIAS_Y4);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_1.Bits.DBS_BIAS_Y5, CAM_DBS_D_BSTBL_1.Bits.DBS_D_BIAS_Y5);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_1.Bits.DBS_BIAS_Y6, CAM_DBS_D_BSTBL_1.Bits.DBS_D_BIAS_Y6);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_1.Bits.DBS_BIAS_Y7, CAM_DBS_D_BSTBL_1.Bits.DBS_D_BIAS_Y7);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_2.Bits.DBS_BIAS_Y8, CAM_DBS_D_BSTBL_2.Bits.DBS_D_BIAS_Y8);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_2.Bits.DBS_BIAS_Y9, CAM_DBS_D_BSTBL_2.Bits.DBS_D_BIAS_Y9);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_2.Bits.DBS_BIAS_Y10, CAM_DBS_D_BSTBL_2.Bits.DBS_D_BIAS_Y10);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_2.Bits.DBS_BIAS_Y11, CAM_DBS_D_BSTBL_2.Bits.DBS_D_BIAS_Y11);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_BSTBL_3.Bits.DBS_BIAS_Y12, CAM_DBS_D_BSTBL_3.Bits.DBS_D_BIAS_Y12);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_CTL.Bits.DBS_HDR_GNP, CAM_DBS_D_CTL.Bits.DBS_D_HDR_GNP);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_CTL.Bits.DBS_HDR_GAIN, CAM_DBS_D_CTL.Bits.DBS_D_HDR_GAIN);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_DBS_CTL.Bits.DBS_HDR_GAIN2, CAM_DBS_D_CTL.Bits.DBS_D_HDR_GAIN2);
		}
...
static ISP_MESSAGE_ENUM dual_cal_bnr(const ISP_DUAL_IN_CONFIG_STRUCT *ptr_in_param, ISP_DUAL_OUT_CONFIG_STRUCT *ptr_out_param)
{
        ...
        ptr_in_param->CAM_CTL_EN_P1.Bits.RMX_EN && ptr_in_param->CAM_CTL_EN_P1.Bits.DMX_EN)
    {
        if (ptr_in_param->CAM_CTL_EN_P1.Bits.BNR_EN)
        {
			...
			if (ptr_out_param->CAM_DMX_D_CROP.Bits.DMX_STR_X & 0x3)
			{
				ptr_out_param->CAM_BPC_D_CON.Bits.BNR_LE_INV_CTL = 0x2 + 0x8;/* 0x1: LE, 0x2: R, 0x4: G, 0x8: B */
			}
            /* left side */
...
static ISP_MESSAGE_ENUM dual_cal_rmg(const ISP_DUAL_IN_CONFIG_STRUCT *ptr_in_param, ISP_DUAL_OUT_CONFIG_STRUCT *ptr_out_param)
{
        ...
        ptr_in_param->CAM_CTL_EN_P1.Bits.RMX_EN && ptr_in_param->CAM_CTL_EN_P1.Bits.DMX_EN)
    {
        if (ptr_in_param->CAM_CTL_EN_P1.Bits.RMG_EN)
        {
			if (ptr_out_param->CAM_DMX_D_CROP.Bits.DMX_STR_X & 0x3)
			{
				ptr_out_param->CAM_RMG_D_HDR_GAIN.Bits.RMG_D_LE_INV_CTL = 0x2 + 0x8;/* 0x1: LE, 0x2: R, 0x4: G, 0x8: B */
			}
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_RMG_HDR_CFG.Bits.RMG_IHDR_EN, CAM_RMG_D_HDR_CFG.Bits.RMG_D_IHDR_EN);
            DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_RMG_HDR_CFG.Bits.RMG_IHDR_LE_FIRST, CAM_RMG_D_HDR_CFG.Bits.RMG_D_IHDR_LE_FIRST);
            DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_RMG_HDR_CFG.Bits.RMG_ZHDR_EN, CAM_RMG_D_HDR_CFG.Bits.RMG_D_ZHDR_EN);
            DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_RMG_HDR_CFG.Bits.RMG_ZHDR_RLE, CAM_RMG_D_HDR_CFG.Bits.RMG_D_ZHDR_RLE);
            DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_RMG_HDR_CFG.Bits.RMG_ZHDR_GLE, CAM_RMG_D_HDR_CFG.Bits.RMG_D_ZHDR_GLE);
            DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_RMG_HDR_CFG.Bits.RMG_ZHDR_BLE, CAM_RMG_D_HDR_CFG.Bits.RMG_D_ZHDR_BLE);
            DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_RMG_HDR_CFG.Bits.RMG_HDR_TH, CAM_RMG_D_HDR_CFG.Bits.RMG_D_HDR_TH);
            DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_RMG_HDR_CFG.Bits.RMG_OSC_TH, CAM_RMG_D_HDR_CFG.Bits.RMG_D_OSC_TH);
            DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_RMG_HDR_GAIN.Bits.RMG_HDR_GAIN, CAM_RMG_D_HDR_GAIN.Bits.RMG_D_HDR_GAIN);
            DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_RMG_HDR_GAIN.Bits.RMG_HDR_RATIO, CAM_RMG_D_HDR_GAIN.Bits.RMG_D_HDR_RATIO);
        }
...
static ISP_MESSAGE_ENUM dual_cal_rrz(const ISP_DUAL_IN_CONFIG_STRUCT *ptr_in_param, ISP_DUAL_OUT_CONFIG_STRUCT *ptr_out_param)
{
        ...
        ptr_in_param->CAM_CTL_EN_P1.Bits.RMX_EN && ptr_in_param->CAM_CTL_EN_P1.Bits.DMX_EN)
    {
        if (ptr_in_param->CAM_CTL_EN_P1.Bits.RRZ_EN)
        {
            ...
            {
			    int rrz_in_w = (0 == ptr_in_param->CAM_CTL_SEL_GLOBAL.Bits.BIN_SEL)?
					(ptr_in_param->CAM_TG_SEN_GRAB_PXL.Bits.PXL_E - ptr_in_param-> CAM_TG_SEN_GRAB_PXL.Bits.PXL_S):
					ptr_in_param->SW.TWIN_RAWI_XSIZE;
                ...
                else
                {
                    ...
                    if (false == RMX_disable)
                    {
                        ...
                        if ((long long)ptr_out_param->CAM_DMX_CROP.Bits.DMX_END_X*DUAL_RRZ_PREC <=
						    ...
						    (long long)(PREC_RRZ_RIGHT_TILE_LOSS + (ptr_in_param->CAM_CTL_EN_P1.Bits.DBS_EN?TILE_LOSS_DBS:0) +
							(ptr_in_param->CAM_CTL_EN_P1.Bits.BNR_EN?TILE_LOSS_BNR:0) +
