...
# for Factory
#LOCAL_C_INCLUDES += $(MTK_PATH_PLATFORM)/hardware/mtkcam/v1/adapter/Scenario/Shot/FBShot
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_PLATFORM)/hardware/include/
...
LOCAL_C_INCLUDES += $(MY_PLATFORM_PATH)/core/featureio/pipe/cfb
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/gralloc_extra/include
...
LOCAL_SHARED_LIBRARIES += libfeatureio.cfb
LOCAL_SHARED_LIBRARIES += libeffecthal.base
# for factory

#-----------------------------------------------------------
LOCAL_MODULE := libeffect.facebeautypp
