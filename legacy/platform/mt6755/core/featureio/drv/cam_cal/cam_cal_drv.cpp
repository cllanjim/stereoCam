                          ...
                          void *a_pCamCalData)
{
   ...
   // dumpEnable = 1; // Jessy add this, adb shell setprop camcaldrv.log cannot work
    ...
    if (/*(i4SensorDevId & (!(SENSOR_DEV_MAIN_3D|SENSOR_DEV_SUB))) ||*//*LukeHu--160201=Remove Unecessary Logical Operator*/
    ...
    pCamcalData->deviceID = i4SensorDevId;/*LukeHu++151106=For Multi-Sensor Calibration*/
#if 1
    ...
    switch(a_eCamCalDataType) {
        ...
        case CAMERA_CAM_CAL_DATA_3D_GEO:                               //seanlin 121016 return none or N3D3D
            ...
            #ifdef CAM_CAL_SUPPORT  //seanlin 120919 it's for compiling mt6589fpga_ca7_ldvt
            pCamcalData->sensorID= i4CurrSensorId;/*LukeHu++151106=For Multi-Sensor Calibration*/
