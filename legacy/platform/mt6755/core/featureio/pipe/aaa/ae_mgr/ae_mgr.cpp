    ...
    , m_i4DeltaSensitivityIdx(0)
{
    ...
    memset(&m_eAEMeterAreaForDPwhileZoom, 0, sizeof(CameraMeteringArea_T));
...
MRESULT AeMgr::PreviewAEInit(MINT32 i4SensorIdx, Param_T &rParam)
{
    ...
    MY_LOG("[PreviewAEInit] m_eSensorDev:%d m_eSensorTG:%d m_i4SensorIdx:%d m_bPerframeAEFlag:%d\n", m_eSensorDev, m_eSensorTG, m_i4SensorIdx, m_bPerframeAEFlag);
...
MRESULT AeMgr::setAEMeteringArea(CameraMeteringArea_T const *sNewAEMeteringArea)
{
  ...
  ALOGD("setAEMeteringArea m_isAeMeterAreaEn=%d",m_isAeMeterAreaEn);
...
//        MY_LOG("No AE Metering area cnt: %d\n", sAEMeteringArea->u4Count);
    ...
    for(i=0; i<u4AreaCnt; i++) {
        ...
        if((sAEMeteringArea->rAreas[i].i4Left != m_eAEMeterArea.rAreas[i].i4Left) || (sAEMeteringArea->rAreas[i].i4Right != m_eAEMeterArea.rAreas[i].i4Right) ||
            ...
            m_eAEMeterAreaForDPwhileZoom.rAreas[i].i4Left  = m_eAEMeterArea.rAreas[i].i4Left;
            m_eAEMeterAreaForDPwhileZoom.rAreas[i].i4Right = m_eAEMeterArea.rAreas[i].i4Right;
            m_eAEMeterAreaForDPwhileZoom.rAreas[i].i4Top   = m_eAEMeterArea.rAreas[i].i4Top;
            m_eAEMeterAreaForDPwhileZoom.rAreas[i].i4Bottom= m_eAEMeterArea.rAreas[i].i4Bottom;
            bAreaChage = MTRUE;
        }
        if((m_eZoomWinInfo.u4XOffset != 0) && (m_eZoomWinInfo.u4YOffset != 0)){
            if ( (m_eAEMeterArea.rAreas[i].i4Left != 0)||(m_eAEMeterArea.rAreas[i].i4Right != 0)||(m_eAEMeterArea.rAreas[i].i4Top != 0)||(m_eAEMeterArea.rAreas[i].i4Bottom != 0) ){
             m_eAEMeterArea.rAreas[i].i4Left   = -1000 + (m_eZoomWinInfo.u4XOffset)*2000/(m_rAEInitInput.rEZoomWin.u4XWidth+2*m_rAEInitInput.rEZoomWin.u4XOffset)  + (sAEMeteringArea->rAreas[i].i4Left + 1000)*m_eZoomWinInfo.u4XWidth/(m_rAEInitInput.rEZoomWin.u4XWidth+2*m_rAEInitInput.rEZoomWin.u4XOffset);
             m_eAEMeterArea.rAreas[i].i4Right  = -1000 + (m_eZoomWinInfo.u4XOffset)*2000/(m_rAEInitInput.rEZoomWin.u4XWidth+2*m_rAEInitInput.rEZoomWin.u4XOffset)  + (sAEMeteringArea->rAreas[i].i4Right+ 1000)*m_eZoomWinInfo.u4XWidth/(m_rAEInitInput.rEZoomWin.u4XWidth+2*m_rAEInitInput.rEZoomWin.u4XOffset);
             m_eAEMeterArea.rAreas[i].i4Top    = -1000 + (m_eZoomWinInfo.u4YOffset)*2000/(m_rAEInitInput.rEZoomWin.u4YHeight+2*m_rAEInitInput.rEZoomWin.u4YOffset) + (sAEMeteringArea->rAreas[i].i4Top+ 1000)*m_eZoomWinInfo.u4YHeight/(m_rAEInitInput.rEZoomWin.u4YHeight+2*m_rAEInitInput.rEZoomWin.u4YOffset);
             m_eAEMeterArea.rAreas[i].i4Bottom = -1000 + (m_eZoomWinInfo.u4YOffset)*2000/(m_rAEInitInput.rEZoomWin.u4YHeight+2*m_rAEInitInput.rEZoomWin.u4YOffset) + (sAEMeteringArea->rAreas[i].i4Bottom+ 1000)*m_eZoomWinInfo.u4YHeight/(m_rAEInitInput.rEZoomWin.u4YHeight+2*m_rAEInitInput.rEZoomWin.u4YOffset);
            }
            MY_LOG("[%s()] AE Metering area is modified for zoom, Modified AE meter area Idx:%d Left:%d Right:%d Top:%d Bottom:%d InitWidth:%d InitHeight:%d\n",__FUNCTION__, i,
                    m_eAEMeterArea.rAreas[i].i4Left, m_eAEMeterArea.rAreas[i].i4Right,
                    m_eAEMeterArea.rAreas[i].i4Top, m_eAEMeterArea.rAreas[i].i4Bottom,m_rAEInitInput.rEZoomWin.u4XWidth,m_rAEInitInput.rEZoomWin.u4YHeight );
            MY_LOG("[%s()] Original1 Backup AE meter area Idx:%d Left:%d Right:%d Top:%d Bottom:%d \n",__FUNCTION__, i,
                  m_eAEMeterAreaForDPwhileZoom.rAreas[i].i4Left, m_eAEMeterAreaForDPwhileZoom.rAreas[i].i4Right,
                  m_eAEMeterAreaForDPwhileZoom.rAreas[i].i4Top , m_eAEMeterAreaForDPwhileZoom.rAreas[i].i4Bottom );
        }
        if((sAEMeteringArea->rAreas[i].i4Left == -1000) && (sAEMeteringArea->rAreas[i].i4Right == 1000) &&
            (sAEMeteringArea->rAreas[i].i4Top == -1000) && (sAEMeteringArea->rAreas[i].i4Bottom == 1000)) {
            MY_LOG("[%s()] AE Metering Area will be reset\n", __FUNCTION__);
            m_eAEMeterArea.rAreas[i].i4Left = 0;
            m_eAEMeterArea.rAreas[i].i4Right = 0;
            m_eAEMeterArea.rAreas[i].i4Top = 0;
            m_eAEMeterArea.rAreas[i].i4Bottom = 0;
        }
    }
    if(bAreaChage == MTRUE) {
        m_bTouchAEAreaChage = MTRUE;
        m_eAEMeterArea.u4Count = u4AreaCnt;
        m_eAEMeterAreaForDPwhileZoom.u4Count = u4AreaCnt;
        if(m_pIAeAlgo != NULL) {
   ...
   if(CUST_ENABLE_FACE_AE() == MTRUE) {
        ...
        // Define FD area number
           ...
           for(ifaceIdx=0; ifaceIdx < m_eAEFDArea.u4Count; ifaceIdx++) {
                ...
                if((m_eZoomWinInfo.u4XOffset != 0) || (m_eZoomWinInfo.u4YOffset != 0)){
                    if ( (m_eAEFDArea.rAreas[ifaceIdx].i4Left != 0)||(m_eAEFDArea.rAreas[ifaceIdx].i4Right != 0)  ||
                         (m_eAEFDArea.rAreas[ifaceIdx].i4Top != 0) ||(m_eAEFDArea.rAreas[ifaceIdx].i4Bottom != 0)     ){
                     m_eAEFDArea.rAreas[ifaceIdx].i4Left   = -1000 + (m_eZoomWinInfo.u4XOffset)*2000/(m_rAEInitInput.rEZoomWin.u4XWidth+2*m_rAEInitInput.rEZoomWin.u4XOffset)  + (m_eAEFDArea.rAreas[ifaceIdx].i4Left + 1000)*m_eZoomWinInfo.u4XWidth/(m_rAEInitInput.rEZoomWin.u4XWidth+2*m_rAEInitInput.rEZoomWin.u4XOffset);
                     m_eAEFDArea.rAreas[ifaceIdx].i4Right = -1000 + (m_eZoomWinInfo.u4XOffset)*2000/(m_rAEInitInput.rEZoomWin.u4XWidth+2*m_rAEInitInput.rEZoomWin.u4XOffset)  + (m_eAEFDArea.rAreas[ifaceIdx].i4Right+ 1000)*m_eZoomWinInfo.u4XWidth/(m_rAEInitInput.rEZoomWin.u4XWidth+2*m_rAEInitInput.rEZoomWin.u4XOffset);
                     m_eAEFDArea.rAreas[ifaceIdx].i4Top    = -1000 + (m_eZoomWinInfo.u4YOffset)*2000/(m_rAEInitInput.rEZoomWin.u4YHeight+2*m_rAEInitInput.rEZoomWin.u4YOffset) + (m_eAEFDArea.rAreas[ifaceIdx].i4Top+ 1000)*m_eZoomWinInfo.u4YHeight/(m_rAEInitInput.rEZoomWin.u4YHeight+2*m_rAEInitInput.rEZoomWin.u4YOffset);
                     m_eAEFDArea.rAreas[ifaceIdx].i4Bottom = -1000 + (m_eZoomWinInfo.u4YOffset)*2000/(m_rAEInitInput.rEZoomWin.u4YHeight+2*m_rAEInitInput.rEZoomWin.u4YOffset) + (m_eAEFDArea.rAreas[ifaceIdx].i4Bottom+ 1000)*m_eZoomWinInfo.u4YHeight/(m_rAEInitInput.rEZoomWin.u4YHeight+2*m_rAEInitInput.rEZoomWin.u4YOffset);
                    }
                    MY_LOG("[%s()] AE FD Metering area is modified for zoom, Modified AE FD meter area Idx:%d Left:%d Right:%d Top:%d Bottom:%d InitWidth:%d InitHeight:%d\n",__FUNCTION__, ifaceIdx,
                            m_eAEFDArea.rAreas[ifaceIdx].i4Left, m_eAEFDArea.rAreas[ifaceIdx].i4Right,
                            m_eAEFDArea.rAreas[ifaceIdx].i4Top, m_eAEFDArea.rAreas[ifaceIdx].i4Bottom ,m_rAEInitInput.rEZoomWin.u4XWidth,m_rAEInitInput.rEZoomWin.u4YHeight );
                    MY_LOG("[%s()] Original Backup AE meter area Idx:%d Left:%d Right:%d Top:%d Bottom:%d \n",__FUNCTION__, ifaceIdx,
         ...
         MY_LOG("[%s()] i4SensorDev:%d line:%d Face Number:%d FaceAEChange:%d", __FUNCTION__, m_eSensorDev, __LINE__, m_eAEFDArea.u4Count, m_bFaceAEAreaChage);
         }
    } else {
...
MBOOL AeMgr::updateAEScenarioMode(EIspProfile_T eIspProfile)
{
    if(m_eSensorMode == ESensorMode_Preview) {
        MY_LOG("[%s()] SensorMode:%d Change AE Pline table to Video\n", __FUNCTION__, m_eSensorMode);
        if(m_pIAeAlgo != NULL) {
            m_pIAeAlgo->setAESensorMode(ESensorMode_Video);
            m_pIAeAlgo->setIsoSpeed(m_u4AEISOSpeed);

            if (m_pAEMapPlineTable != NULL){
                switchSensorModeMaxBVSensitivityDiff(ESensorMode_Video, m_eSensorMode, m_i4DeltaSensitivityIdx, m_i4DeltaBVIdx);
            }
            ...
            if(m_pAEPlineTable != NULL) {   // protect the AE Pline table don't ready
                mr = getAEPLineMappingID(m_eAEScene, ESensorMode_Video, &ePreviewPLineTableID, &eCapturePLineTableID);
                    if(FAILED(mr)) {
                ...
                MY_LOG("[updateAEScenarioMode] setAEScene:%d, AE Pline table is NULL \n",m_eAEScene);
            }
...
MRESULT AeMgr::setZoomWinInfo(MUINT32 u4XOffset, MUINT32 u4YOffset, MUINT32 u4Width, MUINT32 u4Height)
{
    if((m_eZoomWinInfo.u4XOffset != u4XOffset) || (m_eZoomWinInfo.u4XWidth != u4Width) ||
       (m_eZoomWinInfo.u4YOffset != u4YOffset) || (m_eZoomWinInfo.u4YHeight != u4Height)) {
        if ((m_rAEInitInput.rEZoomWin.u4XWidth == 0)||(m_rAEInitInput.rEZoomWin.u4YHeight == 0)){
            m_rAEInitInput.rEZoomWin.u4XOffset = u4XOffset;
            m_rAEInitInput.rEZoomWin.u4XWidth  = u4Width;
            m_rAEInitInput.rEZoomWin.u4YOffset = u4YOffset;
            m_rAEInitInput.rEZoomWin.u4YHeight = u4Height;
        }
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT AeMgr::doPvAEmonitor(MINT32 i4FrameCount, MVOID *pAEStatBuf, MINT32 i4ActiveAEItem, MUINT32 u4AAOUpdate, MBOOL bAAASchedule, MBOOL &bWillUpdateSensorbyI2C)
{
    ...
    if(m_pIAeAlgo != NULL) {
        if(pAEStatisticBuf != NULL)  {
          ...
          localTimer.End();
            ...
            if((m_bIsAutoFlare == MTRUE) && ((bAAASchedule == 0)||(i4ActiveAEItem & E_AE_FLARE))){
                ...
                //MY_LOG("[%s()][getPreviewFlare] i2FlareOffset = %d i2FlareGain = %d \n", __FUNCTION__, i2FlareOffset, i2FlareGain);
                IspTuningMgr::getInstance().setIspFlareGainOffset((ESensorDev_T)m_eSensorDev, i2FlareGain, (-1*i2FlareOffset));
        ...
        // Protect mechanism
     if ( IsNeedUpdateSensor() ){
            if (bAAASchedule == 0){
          bWillUpdateSensorbyI2C = MTRUE;
                MY_LOG("[I2C incorrect]  m_bSetShutterValue/m_bSetGainValue/m_bSetFrameRateValue= %d/%d/%d \n", m_bSetShutterValue, m_bSetGainValue, m_bSetFrameRateValue);
                if(m_eAETargetMode == AE_MODE_MVHDR_TARGET) {
        ...
        m_bCalc = bCalculateAE ;
        m_bApply = bApplyAE ;

        // When perframe and AE schedule is TRUE
        if((m_bPerframeAEFlag == MTRUE) && (bAAASchedule == MFALSE) ) {
           if ( (m_eAETargetMode == AE_MODE_MVHDR_TARGET)||(m_eAETargetMode == AE_MODE_AOE_TARGET) ){
                m_bPerframeAEFlag = MFALSE;
                MY_LOG("[%s()] This is VHDR AE flow \n",__FUNCTION__);
           } else {
            if(m_bTouchAEAreaChage == MTRUE){
                m_bPerframeAEFlag = MFALSE;
                MY_LOG("[%s()] This is Touch AE flow \n",__FUNCTION__);
            } else if (m_bAElimitor == MTRUE){
                m_bPerframeAEFlag = MFALSE;
                MY_LOG("[%s()] This is Limiter AE flow \n",__FUNCTION__);
            } else {
                m_bCalc  = MTRUE ;
                m_bApply = MTRUE ;
                m_bWillUpdateSensorbyI2C = MTRUE; // Inform 3A posting AE thread
                MY_LOG("[%s()] This is Perframe AE flow \n",__FUNCTION__);
            }
        }
        }
    } else {
        ...
        bWillUpdateSensorbyI2C = m_bWillUpdateSensorbyI2C;

        if(m_u4AdbAEPerFrameCtrl) {
            bWillUpdateSensorbyI2C = 1;
            MY_LOG(" m_u4AdbAEPerFrameCtrl=%d, willupdate = %d",m_u4AdbAEPerFrameCtrl, bWillUpdateSensorbyI2C );
            return S_AE_OK;
        }
...
memset(&rAEInput , 0, sizeof(strAEInput ));
    ...
    if ( IsNeedUpdateSensor() ){
       if (bAAASchedule == 0){
            MY_LOG("[I2C incorrect]  Skip dopvAE \n");
            return S_AE_OK;
       }
    }

    // Log out AE schedule
    MY_LOG("[%s()][AEScheduler] AECalc:%d AEApply:%d AEFlare:%d VDnum:%d AvgY:%d\n", __FUNCTION__,
                            bCalculateAE     ,
                            bApplyAE    ,
                            1      ,
                            m_i4WaitVDNum                  ,
    ...
    if(m_bEnableAE && (m_eAEMode!= LIB3A_AE_MODE_OFF)) {
        if ((i4ActiveItem & E_AE_AE_CALC) || (bCalculateAE == MTRUE)) {
            ...
            } else if ((bAAASchedule == MTRUE)||(m_eAETargetMode == AE_MODE_MVHDR_TARGET)||(m_eAETargetMode == AE_MODE_AOE_TARGET)){
                rAEInput.eAeState = AE_STATE_SLOW_MOTION;
                MY_LOG("[%s()]  SLOW_MOTION or VHDR flow\n", __FUNCTION__);
            } else if (m_bAElimitor == MTRUE) {
            ...
            if(m_eZoomWinInfo.bZoomChange == MTRUE) {
                ...
                if (m_bPerframeAEFlag){
                    ...
                    MY_LOG("[%s():PassToAlgo] rAEInput.PreEvSetting[N-1]:%d/%d/%d rAEInput.PreEvSetting[N-2]:%d/%d/%d rAEInput.PreEvSetting[N-3]:%d/%d/%d rAEInput.CycleInfo.m_i4FrameCnt:%d\n", __FUNCTION__,
                ...
                if((m_bAEStable == MTRUE) &&(m_bAFAELock == MFALSE)) {
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT AeMgr::doAFAEmonitor(MINT32 i4FrameCount, MVOID *pAEStatBuf, MINT32 i4ActiveAEItem, MUINT32 u4AAOUpdate, MBOOL bAAASchedule, MBOOL &bWillUpdateSensorbyI2C)
{
    MBOOL bCalculateAE = MFALSE;
    MBOOL bApplyAE = MFALSE;
    MINT32 i4ActiveItem;
    ...
    if(m_bEnableAE && (m_bAdbAELock == MFALSE)) {
        ...
        if ((i4ActiveItem & E_AE_AE_CALC)  || (bCalculateAE == MTRUE)) {
            if((m_eAETargetMode == AE_MODE_AOE_TARGET) || (m_eAETargetMode == AE_MODE_MVHDR_TARGET)) {
                ...
                if(m_pIAeAlgo != NULL) {
                    m_pIAeAlgo->handleAE(&rAEInput, &rAEOutput);
                    //MY_LOG("[Debug_Allen] rAEOutput.bAEStable = %d \n ",rAEOutput.bAEStable);
                } else {
                    MY_LOG("[%s()] The AE algo class is NULL  i4SensorDev = %d line:%d", __FUNCTION__, m_eSensorDev, __LINE__);
                }
                copyAEInfo2mgr(&m_rAEOutput.rPreviewMode, &rAEOutput);
                MY_LOG("[%s():AeAlgo output] Exp/Afe/Isp = %d/%d/%d",__FUNCTION__,m_rAEOutput.rPreviewMode.u4Eposuretime,m_rAEOutput.rPreviewMode.u4AfeGain,m_rAEOutput.rPreviewMode.u4IspGain);
                mPreviewMode = m_rAEOutput.rPreviewMode;
                m_i4WaitVDNum = 0; // reset the delay frame
...
{
    MY_LOG("setPfPara(%d/%d/%d)",exp, afe, isp);
    AE_INFO_T rAEInfo2ISP;
    if(m_pIAeAlgo != NULL) {
        m_pIAeAlgo->getAEInfoForISP(rAEInfo2ISP);
    }
...
strAEOutput rAEOutput;
    ...
    copyAEInfo2mgr(&m_rAEOutput.rPreviewMode, &rAEOutput);
    MY_LOG("[getPreviewParams3] Preview Shutter:%d Sensor gain:%d Isp gain:%d frame rate:%d flare:%d %d ISO:%d\n",
...
AE_EXP_GAIN_MODIFY_T rSensorInputData, rSensorOutputData;
    ...
    if(((m_eAETargetMode == AE_MODE_AOE_TARGET) || (m_eAETargetMode == AE_MODE_MVHDR_TARGET)) && ( m_eCamMode == eAppMode_EngMode || m_bAEReadyCapture == MFALSE)){
...
MRESULT AeMgr::getNvramData(MINT32 i4SensorDev, MINT32 isForce)
{
    MY_LOG("[%s()] i4SensorDev:%d, isForce:%d\n", __FUNCTION__, i4SensorDev, isForce);
...
MRESULT AeMgr::AEInit(Param_T &rParam)
{
    ...
    MY_LOG("[%s] sensor table mapping start : MAX_PLINE_MAP_TABLE = %d,LIB3A_SENSOR_MODE_MAX = %d" ,__FUNCTION__, MAX_PLINE_MAP_TABLE, LIB3A_SENSOR_MODE_MAX);
    ...
    MY_LOG("[%s] sensor table mapping end", __FUNCTION__);
    ...
    if (m_eCamMode == eAppMode_EngMode){
        m_eZoomWinInfo.u4XWidth  = 0;
        m_eZoomWinInfo.u4YHeight = 0;
    }
    ...
    MY_LOG("[%s()] i4SensorDev:%d SensorIdx:%d AE max block width:%d heigh:%d AE meter:%d CamMode:%d AEScene:%d Flicker :%d %d EVcomp:%d ISO:%d %d MinFps:%d MaxFps:%d Limiter:%d m_eZoomWinInfo.u4XOffset/m_eZoomWinInfo.u4YOffset/m_eZoomWinInfo.u4XWidth/m_eZoomWinInfo.u4YHeight = %d/%d/%d/%d \n", __FUNCTION__, 
        ...
        m_i4AEMinFps, m_i4AEMaxFps, m_bAElimitor, m_rAEInitInput.rEZoomWin.u4XOffset, m_rAEInitInput.rEZoomWin.u4YOffset, m_rAEInitInput.rEZoomWin.u4XWidth, m_rAEInitInput.rEZoomWin.u4YHeight);
...
{
    if (m_bAEMgrDebugEnable) {
        MY_LOG("[%s()] i4SensorDev:%d m_bAELock/m_bAPAELock/m_bAFAELock:%d/%d/%d\n", __FUNCTION__, m_eSensorDev, m_bAELock, m_bAPAELock, m_bAFAELock);
    }
    return m_bAELock;
}
...
MRESULT AeMgr::getExposureInfo(ExpSettingParam_T &strHDRInputSetting)
{
    ...
    MY_LOG("[%s()] Input MaxSensorAnalogGain:%d MaxExpTime:%d MinExpTime:%d LineTime:%d MaxSensorGain:%d ExpTime:%d SensorGain:%d FlareOffset:%d DetectFace:%d %d\n", __FUNCTION__,
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT AeMgr::updateAEInitIndex(MINT32 i4LV9Offset)
{
    if(m_pIAeAlgo != NULL) {
        m_pIAeAlgo->updateAEInitIndex(i4LV9Offset);
    } else {
        MY_LOG("The AE algo class is NULL (49)\n");
    }

    MY_LOG("[updateAEInitIndex] i4LV9Offset:%d \n", i4LV9Offset);
...
MRESULT AeMgr::updateCaptureParams(AE_MODE_CFG_T &a_rCaptureInfo)
{
    ...
    if (m_u4AEISOSpeed != LIB3A_AE_ISO_SPEED_AUTO){ // for stereo
        mCaptureMode.u4Eposuretime = (MUINT32)((MUINT64)a_rCaptureInfo.u4Eposuretime*a_rCaptureInfo.u4AfeGain/mCaptureMode.u4AfeGain*a_rCaptureInfo.u4IspGain/mCaptureMode.u4IspGain);
        MY_LOG("[%s():ISO] m_i4SensorDev:%d m_u4AEISOSpeed:%d Original Exp/Afe/Isp=%d/%d/%d , Modified Exp/Afe/Isp=%d/%d/%d \n",
                __FUNCTION__, m_eSensorDev,m_u4AEISOSpeed, a_rCaptureInfo.u4Eposuretime, a_rCaptureInfo.u4AfeGain,a_rCaptureInfo.u4IspGain,
                mCaptureMode.u4Eposuretime, mCaptureMode.u4AfeGain, mCaptureMode.u4IspGain);
    } else {
    ...
    if(m_bEnableAE && getShutterValue()==0) {
...
MRESULT AeMgr::UpdateSensorISPParams(AE_STATE_T eNewAEState)
{
    ...
    switch(eNewAEState)
    {
        ...
        case AE_MANUAL_FRAMERATE_STATE:
            ...
            MY_LOG_IF(m_3ALogEnable,"[%s:s] i4SensorDev:%d VDNum %d, Prev %d/%d/%d, Cur %d/%d/%d, Output %d/%d/%d WOUpdateSensor:%d\n", __FUNCTION__, m_eSensorDev, m_i4WaitVDNum,
                    m_u4PreExposureTime,
                    m_u4PreSensorGain,
                    m_u4PreIspGain,
...
if(m_bPerframeAEFlag){
            ...
            if ((m_i4IspGainDelayFrames == m_i4ShutterDelayFrames)||m_rAEInitInput.rAEPARAM.bPerFrameAESmooth) {
                    if(m_bPerframeAEFlag)
                    {
                        IspTuningMgr::getInstance().setISPAEGain((ESensorDev_T)m_eSensorDev, MFALSE, m_u4PreviousISPgain>>1);
                        MY_LOG("[%s()] Isp gain value(current-pre) = %d %d\n", __FUNCTION__, m_u4PreviousISPgain,m_bPerframeAEFlag); 
                    }
                    else 
                    {                    
                    IspTuningMgr::getInstance().setISPAEGain((ESensorDev_T)m_eSensorDev, MFALSE, m_rAEOutput.rPreviewMode.u4IspGain>>1);
                        MY_LOG("[%s()] Isp gain value(current) = %d %d\n", __FUNCTION__, m_rAEOutput.rPreviewMode.u4IspGain,m_bPerframeAEFlag);
                    }

                    m_AEState = eNewAEState;
            } else if (m_i4IspGainDelayFrames == m_i4ShutterDelayFrames + 1){
                    IspTuningMgr::getInstance().setISPAEGain((ESensorDev_T)m_eSensorDev, MFALSE, m_u4PreviousISPgain>>1);
                    MY_LOG_IF(m_3ALogEnable,"[%s()] Isp gain value(previous) = %d\n", __FUNCTION__, m_u4PreviousISPgain);
                    m_AEState = eNewAEState;
            } else {
                    MY_LOG("Perframe update AE warning : ISPGain delay should be more than 1.\n");
            }
            // Prepare Isp Gain for command sending
            if ((m_i4IspGainDelayFrames - m_i4ShutterDelayFrames) == 1){
...
#define max(a,b)  ((a) > (b) ? (a) : (b))
                    ...
                    if(m_u4SmoothIspGain != mPreviewMode.u4IspGain) {
                        ...
                        MY_LOG_IF(m_3ALogEnable,"[%s()] Isp gain value(VD < ISPdelay) = %d\n", __FUNCTION__, m_u4SmoothIspGain);
                        rAEInfo2ISP.u4IspGain = m_u4SmoothIspGain;
                        m_u4PrevIspGain = m_u4SmoothIspGain;
                        m_u4PreviousISPgain = m_u4SmoothIspGain;  //add this line
...
//                        g_rAEOutput.rPreviewMode.u4IspGain);
                ...
                if(m_i4WaitVDNum == m_i4IspGainDelayFrames) {
                    ...
                    m_u4PreviousISPgain =m_rAEOutput.rPreviewMode.u4IspGain; //add this line
                    m_AEState = eNewAEState;
                }
        ...
        case AE_CAPTURE_STATE:
            ...
            if( (m_bEnableAE == MTRUE) && (m_bMultiCap == MFALSE) &&  (mCaptureMode.u4Eposuretime > m_rAEInitInput.rAEPARAM.strAEParasetting.u4LongCaptureThres) && (m_rAEInitInput.rAEPARAM.strAEParasetting.bEnableLongCaptureCtrl == MTRUE) && (m_bRealISOSpeed != MTRUE)) {
...
MRESULT AeMgr::updatePreviewParamsByiVHDR(strAEOutput *sAEInfo)
{
    ...
    if(m_bRealISOSpeed == MTRUE){ //Eng mode
           ...
           rSensorOutputData.u4SensorExpTime =  strIVHDROutputSetting.u4SEExpTimeInUS ;
           rSensorOutputData.u4SensorExpTime =  strIVHDROutputSetting.u4LEExpTimeInUS ;
           rSensorOutputData.u4SensorGain  =  strIVHDROutputSetting.u4SESensorGain ;
           rSensorOutputData.u4SensorGain  =  strIVHDROutputSetting.u4LESensorGain ;
           rSensorOutputData.u4IspGain     =  strIVHDROutputSetting.u4SEISPGain ;
    ...
    if(m_u4IndexTestCnt < 300) {
        ...
        switch(uTestidx) {
                ...
                case 8: // Shutter Linearity
                        m_rAEOutput.rPreviewMode.u4Eposuretime = 5000*((m_u4IndexTestCnt%100)/10 + 1);
                        m_rAEOutput.rPreviewMode.u4AfeGain = 1024;
                    break;
                case 9: // Gain Linearity
                        m_rAEOutput.rPreviewMode.u4Eposuretime = 10000;
                        m_rAEOutput.rPreviewMode.u4AfeGain = 1024*((m_u4IndexTestCnt%80)/10 + 1);
                    break;

                default:
                    MY_LOG("[startSensorPerFrameControl] Test item:%d isn't supported \n", uTestidx);
                    break;
            }
...
MRESULT AeMgr::updateSensorbyI2C()
{
    ...
    if((m_eAETargetMode == AE_MODE_AOE_TARGET) || (m_eAETargetMode == AE_MODE_MVHDR_TARGET)) {   // mVHDR/iVHDR sensor control
        if(m_bSetShutterValue) {    // update shutter value
            if(m_i4ShutterDelayFrames == m_i4SensorGainDelayFrames) {
                AAASensorMgr::getInstance().set2ShutterParams((ESensorDev_T)m_eSensorDev, m_u4LEHDRshutter, m_u4SEHDRshutter, m_u4UpdateGainValue);
                m_bSetGainValue = MFALSE;
            } else {
        ...
        if(m_bSetShutterValue) {    // update shutter value
            if (m_rAEInitInput.rAEPARAM.bPerFrameAESmooth){
                if ((m_u4UpdateShutterValue != m_PreEvSettingQueue[0].u4Eposuretime)||
                    ...
                    MY_LOG_IF(m_3ALogEnable,"[%s()] Exposure time value = %d\n", __FUNCTION__, m_u4UpdateShutterValue);
                    localTimer.End();
                    if (FAILED(err)) {
                        MY_ERR("AAASensorMgr::getInstance().setSensorExpTime fail\n");
                    }
                } else {
                    MY_LOG_IF(m_3ALogEnable,"[%s()] Exposure time value is repeat (skip send command)= %d\n", __FUNCTION__, m_u4UpdateShutterValue);
                }
            } else {
               AaaTimer localTimer("SetSensorShutter", m_eSensorDev, (m_3ALogEnable & EN_3A_SCHEDULE_LOG));
               err = AAASensorMgr::getInstance().setSensorExpTime((ESensorDev_T)m_eSensorDev, m_u4UpdateShutterValue);
        ...
        if(m_bSetGainValue) {    // update sensor gain value
            if (m_rAEInitInput.rAEPARAM.bPerFrameAESmooth){
                if ((m_u4UpdateGainValue != m_PreEvSettingQueue[0].u4AfeGain)||
                    ...
                    (m_u4UpdateGainValue != m_PreEvSettingQueue[2].u4AfeGain)    ){
                    AaaTimer localTimer("SetSensorGain", m_eSensorDev, (m_3ALogEnable & EN_3A_SCHEDULE_LOG));
                    err = AAASensorMgr::getInstance().setSensorGain((ESensorDev_T)m_eSensorDev, m_u4UpdateGainValue);
                    //err = AAASensorMgr::getInstance().setSensorIso((ESensorDev_T)m_eSensorDev, m_eSensorMode, m_rAEOutput.rPreviewMode.u4RealISO);
                    MY_LOG_IF(m_3ALogEnable,"[%s()] Sensor gain value = %d\n", __FUNCTION__, m_u4UpdateGainValue);
                    localTimer.End();
                    if (FAILED(err)) {
                        MY_ERR("AAASensorMgr::getInstance().setSensorGain fail\n");
                    }
                } else {
                    MY_LOG("[%s()] Sensor gain value is repeat (skip send command)= %d\n", __FUNCTION__, m_u4UpdateGainValue);
                }
            } else {
                AaaTimer localTimer("SetSensorGain", m_eSensorDev, (m_3ALogEnable & EN_3A_SCHEDULE_LOG));
                err = AAASensorMgr::getInstance().setSensorGain((ESensorDev_T)m_eSensorDev, m_u4UpdateGainValue);
...
//MINT8 idx;
    ...
    if((m_bEnableAE == MTRUE) && (mCaptureMode.u4Eposuretime > m_rAEInitInput.rAEPARAM.strAEParasetting.u4LongCaptureThres) && (m_bMultiCap == MFALSE) && (m_rAEInitInput.rAEPARAM.strAEParasetting.bEnableLongCaptureCtrl == MTRUE)&&(m_bRealISOSpeed != MTRUE)) {


        AAASensorMgr::getInstance().getSensorModeDelay(m_eSensorMode, &i4CaptureDelayFrame);

        if (i4CaptureDelayFrame < (m_i4IspGainDelayFrames+2)){
...
MRESULT AeMgr::monitorAndReschedule( MBOOL bAAASchedule, MUINT32 u4AvgYcur, MUINT32 u4AvgYStable, MBOOL *bAECalc, MBOOL *bAEApply )
{
    ...
    //  MY_LOG("[%s()] u2AEStatThrs:%d NumCycleAESkipAfterExit:%d\n", __FUNCTION__ , u2AEStatThrs, NumCycleAESkipAfterExit);
    ...
    bReschedule = (m_bAEMonitorStable && (bStatChange || (m_bFaceAEAreaChage &&(m_u4WOFDCnt>1)) || m_bTouchAEAreaChage));
    ...
    if ( ( *bAEApply == MTRUE )&&
         ( ((AEScheduleFrame%i4framePerAECycle) == m_i4ShutterDelayFrames)||((AEScheduleFrame%i4framePerAECycle) == m_i4SensorGainDelayFrames)) ){
            m_bWillUpdateSensorbyI2C = MTRUE;
    } else {
            m_bWillUpdateSensorbyI2C = MFALSE;
    }

    MY_LOG("[%s()] Calc:%d Apply:%d Cnt:%d Frame:%d ReSchedule:%d Exit:%d Skip:%d bStatChange:%d bAAASchedule:%d frameDelay:%d Stable:%d AEMonitorStable:%d VdCnt:%d ISPdelay:%d FaceArea:%d FaceWOCnt:%d TouchArea:%d u4CwvYcur:%d u4CwvYpre:%d u4AvgYcur:%d isneedupdatesensorisp:%d\n", 
              __FUNCTION__, *bAECalc, *bAEApply, m_u4AEScheduleCnt, AEScheduleFrame, bReschedule, bAEExit, bAESkip ,bStatChange, bAAASchedule, i4framePerAECycle,
              m_bAEStable, m_bAEMonitorStable, m_i4WaitVDNum, m_i4IspGainDelayFrames, m_bFaceAEAreaChage, m_u4WOFDCnt, m_bTouchAEAreaChage,u4AvgYcur, u4AvgYStable, m_pIAeAlgo->getBrightnessAverageValue(), m_bWillUpdateSensorbyI2C);
...
MBOOL AeMgr::WillUpdateSensorbyI2C()
{
    return m_bWillUpdateSensorbyI2C ;
}
...
{
    if(ABS((MINT32)m_pIAeAlgo->getBrightnessAverageValue() - (MINT32)m_u4StableYValue) > 20){
        MY_LOG("[%s()] u4AvgYcur:%d u4AvgYStable:%d u4thres:%d\n", __FUNCTION__ , m_pIAeAlgo->getBrightnessAverageValue(), m_u4StableYValue, 20);
        return MTRUE;
    }
    return MFALSE;
}
...
{
    m_strAECycleInfo.m_i4CycleVDNum = m_i4IspGainDelayFrames + 2;
    m_strAECycleInfo.m_i4ShutterDelayFrames = m_i4IspGainDelayFrames - m_i4ShutterDelayFrames + 1 ;
    m_strAECycleInfo.m_i4GainDelayFrames = m_i4IspGainDelayFrames - m_i4SensorGainDelayFrames + 1 ;
    m_strAECycleInfo.m_i4IspGainDelayFrames = 1;
    m_strAECycleInfo.m_i4FrameCnt = 0;

    MY_LOG("[%s()] m_i4CycleVDNum:%d m_i4ShutterDelayFrames:%d m_i4GainDelayFrames:%d m_i4IspGainDelayFrames:%d m_i4FrameCnt:%d\n", __FUNCTION__,
...
MRESULT AeMgr::updatePreEvSettingQueue(MUINT32 newExpsuretime, MUINT32 newAfegain, MUINT32 newIspGain)
{
    ...
    MY_LOG("[%s()] m_PreEvSettingQueue[N-1]:%d/%d/%d m_PreEvSettingQueue[N-2]:%d/%d/%d m_PreEvSettingQueue[N-3]:%d/%d/%d \n", __FUNCTION__,
...
MRESULT AeMgr::getMShutterCaptureParams(AE_MODE_CFG_T &a_rCaptureInfo)
    {

        float isoValue = 1.0;
        a_rCaptureInfo.u4ExposureMode = (MUINT32)eAE_EXPO_TIME;
        a_rCaptureInfo.i2FlareGain = m_rAEOutput.rPreviewMode.i2FlareGain;
        a_rCaptureInfo.i2FlareOffset = m_rAEOutput.rPreviewMode.i2FlareOffset;
        a_rCaptureInfo.u4Eposuretime = getShutterValue()*1000;


        a_rCaptureInfo.u4IspGain = 1024;
        MY_LOG("[getMShutterCaptureParams] m_eAEISOSpeed:%d ,BV:%d ,u4RealISO:%d", m_u4AEISOSpeed,m_BVvalue,m_rAEOutput.rPreviewMode.u4RealISO);

        switch(m_u4AEISOSpeed) {
            case LIB3A_AE_ISO_SPEED_AUTO:
                isoValue = (float)m_rAEOutput.rPreviewMode.u4RealISO / 100;
                MY_LOG("[getMShutterCaptureParams] isoValue:%f",isoValue);
                break;
            case LIB3A_AE_ISO_SPEED_100:
                isoValue = 1;
                break;
            case LIB3A_AE_ISO_SPEED_150:
                isoValue = 1.5;
                break;
            case LIB3A_AE_ISO_SPEED_200:
                isoValue = 2;
                break;
            case LIB3A_AE_ISO_SPEED_300:
                isoValue = 3;
                break;
            case LIB3A_AE_ISO_SPEED_400:
                isoValue = 4;
                break;
            case LIB3A_AE_ISO_SPEED_600:
                isoValue = 6;
                break;
            case LIB3A_AE_ISO_SPEED_800:
                isoValue = 8;
               break;
            case LIB3A_AE_ISO_SPEED_1200:
                isoValue = 12;
               break;
            case LIB3A_AE_ISO_SPEED_1600:
                isoValue = 16;
                break;
            case LIB3A_AE_ISO_SPEED_2400:
                isoValue = 24;
               break;
        ...
        MY_LOG("[getMShutterCaptureParams] isoValue:%f",isoValue);
        a_rCaptureInfo.u4RealISO = isoValue * 100;

        a_rCaptureInfo.u4AfeGain = (a_rCaptureInfo.u4RealISO * 1024) / m_p3ANVRAM->rAENVRAM.rDevicesInfo.u4MiniISOGain;

        if(a_rCaptureInfo.u4AfeGain > m_p3ANVRAM->rAENVRAM.rDevicesInfo.u4MaxGain){
            a_rCaptureInfo.u4IspGain = (a_rCaptureInfo.u4AfeGain / m_p3ANVRAM->rAENVRAM.rDevicesInfo.u4MaxGain)*1024;
            a_rCaptureInfo.u4AfeGain = m_p3ANVRAM->rAENVRAM.rDevicesInfo.u4MaxGain;
        }
            MY_LOG("[getMShutterCaptureParams] Sensor gain:%d Isp gain:%d u4RealISO:%d u4MiniISOGain:%d u4MaxGain:%d\n", a_rCaptureInfo.u4AfeGain,a_rCaptureInfo.u4IspGain,
            m_rAEOutput.rPreviewMode.u4RealISO,m_p3ANVRAM->rAENVRAM.rDevicesInfo.u4MiniISOGain,m_p3ANVRAM->rAENVRAM.rDevicesInfo.u4MaxGain);

        return S_AE_OK;
    }

MRESULT AeMgr::setShutterValue(int value){
    m_ShutterValue = value;
    return S_AE_OK;
}

MINT32 AeMgr::getShutterValue()
{
