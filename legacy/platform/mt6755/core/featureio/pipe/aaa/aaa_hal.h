...
public:
    ...
    MBOOL         m_bKeepLastStatus;   // Keep last status when re-init. example: AF don't init MCU when continus shot.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  AE/AWB thread
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
    ...
    */
    ...
    /**
    * @brief query sensor static information (when 3A Hal init)
    */
    ...
    MRESULT         getDNGInfo(MBOOL fgPureRaw, DNGInfo_T& rDngInfo) const;
