...
init()
{
    ...
    if(!m_pIspDrv->init("isp_debug")){
        MY_ERR("IspDrv::init(isp_debug) fail \n");
        return MFALSE;
    }
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("isp.debug.dma", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
...
MVOID
IspDebug:: 
dumpIspDebugMessage_DBS() 
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};    
    property_get("isp.debug.dbs", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
    MINT32 i4DBSOption = atoi(value);

    // OBC: TG1
    MY_LOG_IF(m_bDebugEnable,"(CAM_CTL_EN_P1, DBS_EN) = %d\n", ISP_READ_BITS_NOPROTECT(m_pIspDrv , CAM_CTL_EN_P1, DBS_EN));
    
    if (i4DBSOption & 1) {
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_SIGMA) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_SIGMA));
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_BSTBL_0) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_BSTBL_0));
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_BSTBL_1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_BSTBL_1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_BSTBL_2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_BSTBL_2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_BSTBL_3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_BSTBL_3));
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_CTL) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_CTL));
    }
    
    // OBC: TG2
    MY_LOG_IF(m_bDebugEnable,"(CAM_CTL_EN_P1_D, DBS_D_EN) = %d\n", ISP_READ_BITS_NOPROTECT(m_pIspDrv , CAM_CTL_EN_P1_D, DBS_D_EN));
    
    if (i4DBSOption & 2) {
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_D_SIGMA) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_D_SIGMA));
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_D_BSTBL_0) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_D_BSTBL_0));
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_D_BSTBL_1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_D_BSTBL_1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_D_BSTBL_2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_D_BSTBL_2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_D_BSTBL_3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_D_BSTBL_3));
        MY_LOG_IF(m_bDebugEnable,"(CAM_DBS_D_CTL) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_DBS_D_CTL));
    }  
}
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};    
    property_get("isp.debug.obc", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};    
    property_get("isp.debug.bnr", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};    
    property_get("isp.debug.lsc", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};    
    property_get("isp.debug.rpg", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
...
MVOID
IspDebug:: 
dumpIspDebugMessage_UDM() 
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};    
    property_get("isp.debug.udm", value, "0"); // 0: disable, 1: enable
    MBOOL bDebugEnable = atoi(value);

    MY_LOG_IF(m_bDebugEnable,"(CAM_CTL_EN_P2, UDM_EN) = %d\n", ISP_READ_BITS_NOPROTECT(m_pIspDrv , CAM_CTL_EN_P2, UDM_EN));
                                   //506forbuild
    if (bDebugEnable) {
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_INTP_CRS) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_INTP_CRS));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_INTP_NAT) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_INTP_NAT));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_INTP_AUG) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_INTP_AUG));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_LUMA_LUT1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_LUMA_LUT1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_LUMA_LUT2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_LUMA_LUT2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_SL_CTL) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_SL_CTL));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_HFTD_CTL) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_HFTD_CTL));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_NR_STR) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_NR_STR));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_NR_ACT) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_NR_ACT));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_HF_STR) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_HF_STR));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_HF_ACT1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_HF_ACT1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_HF_ACT2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_HF_ACT2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_CLIP) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_CLIP));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_DSB) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_DSB));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_TILE_EDGE) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_TILE_EDGE));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_DSL) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_DSL));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_SPARE_1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_SPARE_1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_SPARE_2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_SPARE_2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_UDM_SPARE_3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_UDM_SPARE_3));
	}
...
dumpIspDebugMessage_NBC() 
{
    ...
    if (bDebugEnable) {
        ...
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_Y4LUT1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_Y4LUT1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_Y4LUT2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_Y4LUT2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_Y4LUT3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_Y4LUT3));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_C4LUT1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_C4LUT1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_C4LUT2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_C4LUT2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_C4LUT3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_C4LUT3));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_A4LUT2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_A4LUT2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_A4LUT3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_A4LUT3));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_L4LUT1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_L4LUT1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_L4LUT2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_L4LUT2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_L4LUT3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_L4LUT3));
        ...
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_LCE) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_LCE));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_MED1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_MED1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_MED2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_MED2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_MED3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_MED3));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_MED4) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_MED4));
        ...
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_ACT1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_ACT1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_ACT2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_ACT2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR_ACT3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR_ACT3));
...
MVOID
IspDebug:: 
dumpIspDebugMessage_NBC2() 
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};    
    property_get("isp.debug.nbc2", value, "0"); // 0: disable, 1: enable
    MBOOL bDebugEnable = atoi(value);

    MY_LOG_IF(m_bDebugEnable,"(CAM_CTL_EN_P2, NBC2_EN) = %d\n", ISP_READ_BITS_NOPROTECT(m_pIspDrv , CAM_CTL_EN_P2, NBC2_EN));

    if (bDebugEnable) {
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_CON1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_CON1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_CON2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_CON2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_YAD1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_YAD1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_Y4LUT1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_Y4LUT1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_Y4LUT2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_Y4LUT2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_Y4LUT3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_Y4LUT3));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_L4LUT1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_L4LUT1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_L4LUT2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_L4LUT2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_L4LUT3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_L4LUT3));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_CAD) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_CAD));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_PTC) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_PTC));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_LCE) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_LCE));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_MED1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_MED1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_MED2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_MED2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_MED3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_MED3));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_MED4) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_MED4));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_ACTY) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_ACTY));
        MY_LOG_IF(m_bDebugEnable,"(CAM_ANR2_ACTC) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_ANR2_ACTC));
        ...
        MY_LOG_IF(m_bDebugEnable,"(CAM_CCR_HUE1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_CCR_HUE1));
        MY_LOG_IF(m_bDebugEnable,"(CAM_CCR_HUE2) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_CCR_HUE2));
        MY_LOG_IF(m_bDebugEnable,"(CAM_CCR_HUE3) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_CCR_HUE3));        
        MY_LOG_IF(m_bDebugEnable,"(CAM_BOK_CON) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_BOK_CON));
        MY_LOG_IF(m_bDebugEnable,"(CAM_BOK_TUN) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_BOK_TUN));
        MY_LOG_IF(m_bDebugEnable,"(CAM_BOK_OFF) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_BOK_OFF));
    }
...
dumpIspDebugMessage()
{
	...
	MY_LOG_IF(m_bDebugEnable,"(CAM_CTL_EN_P2, NSL2_EN) = %d\n", ISP_READ_BITS_NOPROTECT(m_pIspDrv , CAM_CTL_EN_P2, NSL2_EN));
    MY_LOG_IF(m_bDebugEnable,"(CAM_CTL_EN_P2, NSL2A_EN) = %d\n", ISP_READ_BITS_NOPROTECT(m_pIspDrv , CAM_CTL_EN_P2, NSL2A_EN));
    MY_LOG_IF(m_bDebugEnable,"(CAM_CTL_EN_P2, NSL2B_EN) = %d\n", ISP_READ_BITS_NOPROTECT(m_pIspDrv , CAM_CTL_EN_P2, NSL2B_EN));
    MY_LOG_IF(m_bDebugEnable,"(CAM_CTL_EN_P2, SL2C_EN) = %d\n", ISP_READ_BITS_NOPROTECT(m_pIspDrv , CAM_CTL_EN_P2, SL2C_EN));

    MY_LOG_IF(m_bDebugEnable,"ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_NSL2_CEN) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_NSL2_CEN));
    MY_LOG_IF(m_bDebugEnable,"ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_NSL2_RR_CON0) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_NSL2_RR_CON0));
    MY_LOG_IF(m_bDebugEnable,"ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_NSL2_RR_CON1) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_NSL2_RR_CON1));
    MY_LOG_IF(m_bDebugEnable,"ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_NSL2_GAIN) = 0x%8x\n", ISP_READ_REG_NOPROTECT(m_pIspDrv , CAM_NSL2_GAIN));
