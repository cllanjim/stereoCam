...
LOCAL_C_INCLUDES:= \
	 ...
	 $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/core/featureio/pipe/heartrate \
	 ...
	 $(TOP)/$(MTK_MTKCAM_PLATFORM)/include/mtkcam/algorithm/libhrd \
...
LOCAL_MODULE := libcam.featureio.pipe.hrd
