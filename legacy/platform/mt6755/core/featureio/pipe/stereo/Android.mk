...
LOCAL_C_INCLUDES += \
  ...
  $(TOP)/$(MTK_ROOT)/hardware/mtkcam/ext/include \
  $(TOP)/$(MTK_ROOT)/hardware/mtkcam/legacy/include \
  $(TOP)/$(MTK_ROOT)/hardware/mtkcam/legacy/include/mtkcam \
  $(TOP)/$(MTK_ROOT)/hardware/mtkcam/legacy/include/mtkcam/hal \
...
#-----------------------------------------------------------
ifeq ($(MTK_CAM_STEREO_CAMERA_FACING),rear)
    LOCAL_CFLAGS += -DSTEREO_CAM_FACING=1
endif

ifeq ($(MTK_CAM_STEREO_CAMERA_FACING),front)
    LOCAL_CFLAGS += -DSTEREO_CAM_FACING=2
endif
