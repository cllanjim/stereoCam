...
#include <mtkcam/hal/IHalSensor.h>      //in common include folder
...
bool StereoSettingProvider::bEnableLog = false;
...
//    pPipHal->GetSensorMaxFrameRate(main2_idx, capFps_Main2, prvFps_Main2);  // main2 always full size(capFps)
    ...
    //
    char* strJPSSize = (char *)malloc(12*sizeof(char));
    sprintf(strJPSSize, "%dx%d", rectifySize().w*2, rectifySize().h);
