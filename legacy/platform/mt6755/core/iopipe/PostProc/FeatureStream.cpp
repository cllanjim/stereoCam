...
ESoftwareScenario const gSenDevSwScenMap[EFeatureStreamTag_total][SENSOR_DEV_MAIN_3D+1]=
{
    {eSoftwareScenario_Main_Normal_Stream,eSoftwareScenario_Main_Normal_Stream,eSoftwareScenario_Sub_Normal_Stream,\
        eSoftwareScenario_total_num,eSoftwareScenario_Main2_Normal_Stream,eSoftwareScenario_total_num},//EFeatureStreamTag_Stream
    {eSoftwareScenario_Main_Vfb_Stream_1,eSoftwareScenario_Main_Vfb_Stream_1,eSoftwareScenario_Sub_Vfb_Stream_1,\
        eSoftwareScenario_total_num,eSoftwareScenario_Main2_Vfb_Stream_1,eSoftwareScenario_total_num},//EFeatureStreamTag_vFB_Stream
    {eSoftwareScenario_Main_Vfb_Stream_2,eSoftwareScenario_Main_Vfb_Stream_2,eSoftwareScenario_Sub_Vfb_Stream_2,\
        eSoftwareScenario_total_num,eSoftwareScenario_Main2_Vfb_Stream_2,eSoftwareScenario_total_num},//EFeatureStreamTag_vFB_FB
    {eSoftwareScenario_Main_Mfb_Capture,eSoftwareScenario_Main_Mfb_Capture,eSoftwareScenario_Sub_Mfb_Capture,\
        eSoftwareScenario_total_num,eSoftwareScenario_Main2_Mfb_Capture,eSoftwareScenario_total_num},//EFeatureStreamTag_MFB_Cap
    {eSoftwareScenario_Main_Mfb_Blending,eSoftwareScenario_Main_Mfb_Blending,eSoftwareScenario_Sub_Mfb_Blending,\
        eSoftwareScenario_total_num,eSoftwareScenario_Main2_Mfb_Blending,eSoftwareScenario_total_num},//EFeatureStreamTag_MFB_Bld
    {eSoftwareScenario_Main_Mfb_Mixing,eSoftwareScenario_Main_Mfb_Mixing,eSoftwareScenario_Sub_Mfb_Mixing,\
        eSoftwareScenario_total_num,eSoftwareScenario_Main2_Mfb_Mixing,eSoftwareScenario_total_num},//EFeatureStreamTag_MFB_Mix
    {eSoftwareScenario_Main_VSS_Mfb_Capture,eSoftwareScenario_Main_VSS_Mfb_Capture,eSoftwareScenario_Sub_VSS_Mfb_Capture,\
        eSoftwareScenario_total_num,eSoftwareScenario_Main2_VSS_Mfb_Capture,eSoftwareScenario_total_num},//EFeatureStreamTag_MFB_Cap_Vss
    {eSoftwareScenario_Main_VSS_Mfb_Blending,eSoftwareScenario_Main_VSS_Mfb_Blending,eSoftwareScenario_Sub_VSS_Mfb_Blending,\
        eSoftwareScenario_total_num,eSoftwareScenario_Main2_VSS_Mfb_Blending,eSoftwareScenario_total_num},//EFeatureStreamTag_MFB_Bld_Vss
    {eSoftwareScenario_Main_VSS_Mfb_Mixing,eSoftwareScenario_Main_VSS_Mfb_Mixing,eSoftwareScenario_Sub_VSS_Mfb_Mixing,\
        eSoftwareScenario_total_num,eSoftwareScenario_Main2_VSS_Mfb_Mixing,eSoftwareScenario_total_num},//EFeatureStreamTag_MFB_Mix_Vss
    ...
    {eSoftwareScenario_Main_Pure_Raw_Stream,eSoftwareScenario_Main_Pure_Raw_Stream,eSoftwareScenario_Sub_Pure_Raw_Stream,\
        eSoftwareScenario_total_num,eSoftwareScenario_Main2_Pure_Raw_Stream,eSoftwareScenario_total_num},//EFeatureStreamTag_PRaw_Stream
    {eSoftwareScenario_Main_CC_Raw_Stream,eSoftwareScenario_Main_CC_Raw_Stream,eSoftwareScenario_Sub_CC_Raw_Stream,\
        eSoftwareScenario_total_num,eSoftwareScenario_Main2_CC_Raw_Stream,eSoftwareScenario_total_num},//EFeatureStreamTag_PRaw_Stream
};
...
init()
{
	...
	//add by westalgo for main2
	//if ((mSWScen == eSoftwareScenario_Main2_N3D_Stream) && (mOpenedSensor == 4))
	//{
	//	mSWScen = eSoftwareScenario_Main_Normal_Capture;
	//}
    ...
    QParams const& rParams)
{
    ...
    else
    {
        ...
        LOG_INF("mSWScen(%d),EBufferTag(%d)",mSWScen,tag);
    ...
    QFeatureData& rFeatureData)
{
    ...
    else
    {
        ...
        LOG_DBG("mSWScen(%d),EBufferTag(%d)",mSWScen,tag);
        ret=mpHalPipeWrapper->enque(mSWScen,pixIdP2,(rParams),this->mpPostProcPipe,this->mDequeuedBufList,tag,rFeatureData);
        if(!ret)
        {
            LOG_ERR("enque Fail");
        }
    ...
    MINT64 i8TimeoutNs)
{
    ...
    QFeatureData dummyData;
    ret=mpHalPipeWrapper->deque((rParams),this->mpPostProcPipe,(MUINTPTR)(&mDequeuedBufList),i8TimeoutNs,dummyData);
    FUNCTION_LOG_END;
    return ret;
}
    ...
    )
{
    ...
    ret=mpHalPipeWrapper->deque((rParams),this->mpPostProcPipe,(MUINTPTR)(&mDequeuedBufList),i8TimeoutNs,rFeatureData);
    FUNCTION_LOG_END;
    return ret;
}
