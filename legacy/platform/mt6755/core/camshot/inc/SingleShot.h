...
protected:  ////    callback
    static  MBOOL   fgNodeNotifyCallback(MVOID* user, NSCamNode::NodeNotifyInfo const msg);
    static  MBOOL   fgNodeDataCallback(MVOID* user, NSCamNode::NodeDataInfo const msg);
