...
public:     ////    Info.
    virtual MBOOL   setPrvBufHdl(MVOID* pCamBufHdl) { return MTRUE; }
...
protected:  //// helper function
    ...
    MBOOL           tryUnRegisterBuffer(IImageBuffer* const pBuf);
    ...
    MBOOL           getSensorStaticInfo(NSCam::SensorStaticInfo& sensorStaticInfo);
