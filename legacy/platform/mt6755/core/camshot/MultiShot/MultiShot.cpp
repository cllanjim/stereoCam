...
MAP_TYPE2BIT(PASS2_CAP_DST_2      , 28);
MAP_TYPE2BIT(PASS2_CAP_DST_3      , 29);
...
static const struct map_data2node gMapData2Node_CapPrv[] =
{
    ...
    { DATA_MAINYUV       , PASS2_CAP_DST_1 , bitS3(CONTROL_CAP_SRC, PASS2_CAP_SRC, PASS2_CAP_DST_1)                } ,
#if THUMB_USE_IMG2O
    { DATA_THUMBNAILYUV  , PASS2_CAP_DST_3 , bitS3(CONTROL_CAP_SRC, PASS2_CAP_SRC, PASS2_CAP_DST_3)                } ,
#else
    { DATA_THUMBNAILYUV  , PASS2_CAP_DST_0 , bitS3(CONTROL_CAP_SRC, PASS2_CAP_SRC, PASS2_CAP_DST_0)                } ,
#endif
    { DATA_POSTVIEW      , PASS2_PRV_DST_0 , bitS3(CONTROL_PRV_SRC, PASS2_PRV_SRC, PASS2_PRV_DST_0)                } ,
    { DATA_MAINJPEG      , JPEG_ENC_HW_DST , bitS2(JPEG_ENC_HW_SRC, JPEG_ENC_HW_DST)              } ,
    { DATA_ROTTHUMBYUV   , TRANSFORM_DST_1 , bitS2(TRANSFORM_SRC  , TRANSFORM_DST_1)              } ,
    { DATA_THUMBNAILJPEG , JPEG_ENC_SW_DST , bitS2(JPEG_ENC_SW_SRC, JPEG_ENC_SW_DST)              } ,
    { DATA_DEBUGINFO     , 0               , bitS2(CONTROL_DBGINFO, SHOTCB_DBGINFO_SRC)           } ,
    { DATA_DUMP_IMG3O    , PASS2_CAP_DST_2 , bitS3(CONTROL_CAP_SRC, PASS2_CAP_SRC, PASS2_CAP_DST_2)                } ,
...
static const struct map_data2node gMapData2Node_Cap[] =
{
    { DATA_FULLRAW       , PASS1_FULLRAW   , bitS2(PASS1_FULLRAW, CONTROL_FULLRAW)                } ,
    { DATA_MAINYUV       , PASS2_CAP_DST_1 , bitS3(CONTROL_CAP_SRC, PASS2_CAP_SRC, PASS2_CAP_DST_1)                } ,
    { DATA_POSTVIEW      , PASS2_CAP_DST_0 , bitS3(CONTROL_CAP_SRC, PASS2_CAP_SRC, PASS2_CAP_DST_0)                } ,
    { DATA_THUMBNAILYUV  , 0               , bitS2(CONTROL_CAP_SRC, PASS2_CAP_SRC)                } ,
    { DATA_MAINJPEG      , JPEG_ENC_HW_DST , bitS3(PASS2_CAP_DST_1, JPEG_ENC_HW_SRC, JPEG_ENC_HW_DST)              } ,
    { DATA_ROTTHUMBYUV   , TRANSFORM_DST_1 , bitS2(TRANSFORM_SRC  , TRANSFORM_DST_1)              } ,
    { DATA_THUMBNAILJPEG , JPEG_ENC_SW_DST , bitS3(TRANSFORM_DST_1, JPEG_ENC_SW_SRC, JPEG_ENC_HW_DST)              } ,
    { DATA_DEBUGINFO     , 0               , bitS2(CONTROL_DBGINFO, SHOTCB_DBGINFO_SRC)           } ,
    { DATA_DUMP_IMG3O    , PASS2_CAP_DST_2 , bitS3(CONTROL_CAP_SRC, PASS2_CAP_SRC, JPEG_ENC_HW_DST)                } ,
    { DATA_FULLRAW_CB       , 0 , bitS3(CONTROL_CAP_SRC, SHOTCB_RAWDATA_SRC , SHOTCB_RAWDATA_DST) } ,
    { DATA_MAINYUV_CB       , 0 , bitS3(PASS2_CAP_DST_1, SHOTCB_YUVDATA_SRC , SHOTCB_YUVDATA_DST) } ,
...
#if THUMB_USE_IMG2O
// if need transform
    RULE( PASS2_CAP_DST_3    , TRANSFORM_SRC        , CAPPASS2NODE , IMGTRANS     , 1, 2 ) ,
    RULE( TRANSFORM_DST_1    , JPEG_ENC_SW_SRC      , IMGTRANS     , SWJPEGNODE   , 2, 2 ) ,
// else
    RULE( PASS2_CAP_DST_3    , JPEG_ENC_SW_SRC      , CAPPASS2NODE , SWJPEGNODE   , 1, 1 ) ,
// endif
#else
// if need transform
