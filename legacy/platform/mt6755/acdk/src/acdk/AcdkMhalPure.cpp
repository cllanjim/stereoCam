...
MINT32 AcdkMhalPure::acdkMhalPreviewStart(MVOID *a_pBuffIn)
{
    ...
    m_tgi.index       = EPortIndex_TG1I;//  port index
#else
    ...
    m_rrzo.u4Stride[ESTRIDE_1ST_PLANE] = (((m_rrzo.crop1.w*10)/8)*3)/2;//  unit:PIXEL
...
//#define PASS2_FULLG
    ...
    if(is_yuv_sensor == 0)
    {
        ...
        m_imgi.u4Stride[ESTRIDE_1ST_PLANE] = m_imgi.u4ImgWidth*10/8*3/2;    //  byte
    }
    else
    {
