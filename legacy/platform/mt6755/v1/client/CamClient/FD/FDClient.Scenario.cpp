...
//********************************************************************************************//
    ...
    //Fix me
        mpFDHalObj->halFTBufferCreateAsync(dst_rgb, src_buf, plane, srcWidth, srcHeight);
    ...
    if(plane == 1)
    {
        ...
        ret1 = mpFDHalObj->halFDDo((unsigned char *)0, dst_rgb,  dst_y, rDoSD, Rotation_Info, (unsigned char *)rQueNode.getImgBuf()->getPhyAddr());
    }
    else
        ret1 = mpFDHalObj->halFDDo((unsigned char *)0, dst_rgb,  (unsigned char *)rQueNode.getImgBuf()->getVirAddr(), rDoSD, Rotation_Info, (unsigned char *)rQueNode.getImgBuf()->getPhyAddr());
