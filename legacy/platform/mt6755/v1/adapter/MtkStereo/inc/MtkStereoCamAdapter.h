...
protected:  ////
    ...
    static void*                    doThreadRecord(void* arg);

    bool                            main2record();

    static void*                    doThreadZsd(void* arg);
...
protected:  ////                    Data Members.
    ...
    pthread_t                       mThreadPrecap = 0;
    pthread_t                       mThreadRecord = 0;
    DefaultCtrlNode::MODE_TYPE      mModeType;

    // DNG
    int32_t                         mEnRaw16CB;
    camera_metadata* pDstStaticMetadata           = nullptr;
    camera_metadata* pDstResultMetadata           = nullptr;

    // hwsync obj
    HWSyncDrv*                      mpHwSyncDrv;
};
