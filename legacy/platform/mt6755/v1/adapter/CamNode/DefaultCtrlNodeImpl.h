                                 ...
                                 , public I3ACallBack
{
    ...
    public: // ctor & dtor
        ...
        virtual void    setShotMode(MUINT32 shotMode);
    ...
    public: // operations
        ...
        //EIS thread
        virtual MBOOL   threadFunEis();
        virtual MBOOL   waiThreadDoneEis();
        static void*    threadLoopEis(void* arg);
        pthread_t       mThreadHandleEis;
        MUINT32         mEisThreadState;
    //
    private:
    ...
    private:
        ...
        MBOOL                   mResume3AAterZsdExt;            // for make check if need to resume AE after Zsd Ext Shot
        MUINT32                 mZSDEXTLastRealISO_Last;
        MUINT32                 mZSDEXTLastRealISO_Current;
        // for PDAF
        MUINT32                 mPDAFFrameCount;                // 1 pure raw in x frame
        MBOOL                   mbIsPureRawPDAFOn;              // is pureRAw PDAF mode on
        typedef struct
        {
            MBOOL       isPushed;
            MUINT32     magicNum;
    ...
    protected:
        ...
        MUINT32             mRollbackBufNumPrv;
        MUINT32             mRollbackBufPeriod;
        MUINT32             mRollbackBufCnt;
        MUINT32             mRollbackBufCnt_Prv;
        ...
        //
        mutable Mutex       mLockStop;
        mutable Condition   mCondStop;
        MUINT32             mPostBufCount;
        MUINT32             mRetBufCount;
