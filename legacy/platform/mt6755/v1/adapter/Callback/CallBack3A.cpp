...
)
{
    ...
    //
    if( _msgType == I3ACallBack::eID_NOTIFY_STEREO_WARNING &&
        (mspCamMsgCbInfo->mMsgEnabled & MTK_CAMERA_MSG_EXT_NOTIFY_STEREO_WARNING) )
    {
    ...
    //
    if( _msgType == I3ACallBack::eID_NOTIFY_STEREO_DISTANCE &&
        (mspCamMsgCbInfo->mMsgEnabled & MTK_CAMERA_MSG_EXT_NOTIFY_STEREO_DISTANCE) )
    {
        mspCamMsgCbInfo->mNotifyCb(
                    MTK_CAMERA_MSG_EXT_NOTIFY,
                    MTK_CAMERA_MSG_EXT_NOTIFY_STEREO_DISTANCE,
                    _ext1,
                    mspCamMsgCbInfo->mCbCookie
                    );
    }
