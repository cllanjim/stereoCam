...
#-----------------------------------------------------------
LOCAL_SRC_FILES += constructStaticMetadata.cpp
LOCAL_SRC_FILES += MetadataProvider.cpp
LOCAL_SRC_FILES += MetadataProviderManager.cpp
...
#-----------------------------------------------------------
LOCAL_WHOLE_STATIC_LIBRARIES += libcam.metadataprovider.custom
#
#-----------------------------------------------------------
...
LOCAL_MODULE := libcam.metadataprovider_static
