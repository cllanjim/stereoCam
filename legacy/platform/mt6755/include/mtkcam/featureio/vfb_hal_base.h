...
struct MTKPipeVfbProcInfo
{
    ...
    MUINT8* DsImgAddr;
    void*   FaceMetadata;
    MUINT32 cfb_pos[MAXFACENUM][2]; // it should be 0 if no FD info     
    MINT32  ClipWidth;
    MINT32  ClipHeight;
    MINT32  DsClipWidth;
    MINT32  DsClipHeight;
...
public:
    ...
    static halVFBBase* createInstance(MBOOL IsVFB);
    virtual void      destroyInstance(MBOOL IsVFB) = 0;
    virtual ~halVFBBase() {};
...
public:
    ...
    virtual void destroyInstance(MBOOL IsVFB);
    //
    halVFBTmp() {};
    virtual ~halVFBTmp() {};
};
