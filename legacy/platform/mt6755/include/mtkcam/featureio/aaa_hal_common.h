...
{
    // static
    MINT32 i4SensorBlackLevelPattern[4];
    MINT32 i4SensorInfoWhiteLevel;
    MINT32 i4TransformDenominator;                  // for rational
    MINT32 i4SensorColorTransform1[9];
    MINT32 i4SensorCalibrationTransform1[9];
    MINT32 i4SensorForwardTransform1[9];
    MUINT8 u1SensorReferenceIlluminant1;
    MUINT8 u1SensorInfoColorFilterArrangement;
    MINT32 i4SensorActiveArray[4];
    MINT32 i4ShadingMapSize[2];
    // dynamic
    MINT64 i8SensorExposureTime;
    MINT32 i4SensorSensitivity;
    MINT32 i4SensorNeutralColorPointNumerator[3];
    MINT32 i4SensorNeutralColorPointDenominator[3];    // for rational
    MFLOAT fLensFocalLength;
    MFLOAT fLensAperture;
    double dSensorNoiseProfile[8];
...
struct ParamIspProfile_T
{
    ...
    ParamIspProfile_T()
        ...
        , i4MagicNum(0)
        , iEnableRPG(0)
        , iValidateOpt(EParamValidate_All)
        , pOutDngInfo(NULL)
    {}
    ...
    ParamIspProfile_T(
        ...
        MINT32        iEnableRPG_,
        MINT32        iValidateOpt_,
        DNGInfo_T*    pOutDngInfo_)
        : eIspProfile(eIspProfile_)
        , i4MagicNum(i4MagicNum_)
        , iEnableRPG(iEnableRPG_)
        , iValidateOpt(iValidateOpt_)
        , pOutDngInfo(pOutDngInfo_)
    {}
};
