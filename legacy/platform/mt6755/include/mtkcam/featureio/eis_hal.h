...
public:
    ...
    virtual MINT32 ConfigCalibration(const EIS_PASS_ENUM &aEisPass,const EIS_HAL_CONFIG_DATA &aEisConfig) = 0;
    ...
    virtual MINT32 DoCalibration(const EIS_PASS_ENUM &aEisPass,EIS_HAL_CONFIG_DATA *apEisConfig = NULL,MINT64 aTimeStamp = -1,MBOOL bRecording = MFALSE) = 0;
