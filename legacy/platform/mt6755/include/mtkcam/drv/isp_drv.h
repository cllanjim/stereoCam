...
#define CAM_CTL_EN_P1_CPG_EN                    (1L<<23)
#define CAM_CTL_EN_P1_DBS_EN                    (1L<<24)
#define CAM_CTL_EN_P1_rsv_25                    (1L<<25)
...
#define CAM_CTL_EN_P1_D_CPG_D_EN                  (1L<<23)
#define CAM_CTL_EN_P1_D_DBS_D_EN                  (1L<<24)
#define CAM_CTL_EN_P1_D_rsv_25                    (1L<<25)
...
#define CAM_CTL_EN_P2_NSL2_EN                   (1L<<2)
#define CAM_CTL_EN_P2_UDM_EN                    (1L<<3)
...
#define CAM_CTL_EN_P2_NBC2_EN                   (1L<<16)
...
#define CAM_CTL_EN_P2_NSL2A_EN                  (1L<<24)
#define CAM_CTL_EN_P2_NSL2B_EN                  (1L<<25)
...
//TH    CAM_TOP_IMGSYS  = 0, // 99   15000000~15000188
    ...
    CAM_CTL_VHDR,        // 2    15004590~15004594
    ...
    CAM_ISP_DBS,         // 6    15004740~15004754
    ...
    CAM_ISP_UDM,         // 19   150048A0~150048E8
    ...
    CAM_ISP_NBC_TBL,	 // 256	15007600~150079FF	// for ANR table
    CAM_ISP_NBC,         // 32   15007A00~15007A7C
    ...
    CAM_ISP_NSL2,        // 10    15004A78~15004A9C
    //CAM_ISP_SL2B,        // 7    15004F60~15004F78
    CAM_ISP_NSL2B,       // 10    15004A50~15004A74
    ...
    CAM_CTL_VHDR_D,      // 2    15006590~15006594
    ...
    CAM_ISP_DBS_D,       // 6    15006740~15006754
    ...
    CAM_ISP_NBC2,        // 48   15007B00~15007BBC
    CAM_ISP_NSL2A,       // 10    15004A20~15004A44
    ...
    CAM_DMA_IMGO_SV2,    // 7    1500922C~15009244 //remove base_addr set by CQ0C
    ...
    CAM_ISP_RWB,		 // 9    15007BC0~15007BE0	// for RWB sensor
    CAM_ISP_ISO,		 // 1    15007BE4	// for ISO adaptive
    CAM_RESERVED_00,
    CAM_DUMMY_,
    CAM_MODULE_MAX
...
{
    eIspTuningMgrFuncBit_Dbs            = 0,
    eIspTuningMgrFuncBit_Dbs_d          = 1,
    eIspTuningMgrFuncBit_Obc            = 2,
    eIspTuningMgrFuncBit_Obc_d          = 3,
    eIspTuningMgrFuncBit_Lsc            = 4,
    eIspTuningMgrFuncBit_Lsc_d          = 5,
    eIspTuningMgrFuncBit_Bnr            = 6,
    eIspTuningMgrFuncBit_Bnr_d          = 7,
    eIspTuningMgrFuncBit_Rpg            = 8,
    eIspTuningMgrFuncBit_Rpg_d          = 9,
    eIspTuningMgrFuncBit_Rmg            = 10,
    eIspTuningMgrFuncBit_Rmg_d          = 11,
    eIspTuningMgrFuncBit_Pgn            = 12,
    //eIspTuningMgrFuncBit_Sl2            = 13,
    eIspTuningMgrFuncBit_Nsl2            = 13,
    //eIspTuningMgrFuncBit_Cfa            = 14,
    eIspTuningMgrFuncBit_Udm            = 14,
    eIspTuningMgrFuncBit_Ccl            = 15,
    eIspTuningMgrFuncBit_G2g            = 16,
    eIspTuningMgrFuncBit_Ggm_Rb         = 17,
    eIspTuningMgrFuncBit_Ggm_G          = 18,
    eIspTuningMgrFuncBit_Mfb_TuneCon    = 19,
    eIspTuningMgrFuncBit_G2c_Conv       = 20,
    eIspTuningMgrFuncBit_G2c_Shade      = 21,
    eIspTuningMgrFuncBit_Nbc            = 22,
    eIspTuningMgrFuncBit_Pca_Tbl        = 23,
    eIspTuningMgrFuncBit_Pca_Con        = 24,
    eIspTuningMgrFuncBit_Seee           = 25,
    eIspTuningMgrFuncBit_Lce            = 26,
    eIspTuningMgrFuncBit_Nr3d_Blending  = 27,
    eIspTuningMgrFuncBit_Nr3d_Lmt       = 28,
    //eIspTuningMgrFuncBit_Sl2b           = 29,
    eIspTuningMgrFuncBit_Nsl2b          = 29,
    eIspTuningMgrFuncBit_Sl2c           = 30,
    eIspTuningMgrFuncBit_Mix3           = 31,
    //eIspTuningMgrFuncBit_ImgSel         = 32,
    //eIspTuningMgrFuncBit_ImgSel_d       = 33,
    eIspTuningMgrFuncBit_Nbc2			= 32,
    eIspTuningMgrFuncBit_Nsl2a			= 33,
    eIspTuningMgrFuncBit_Nbc_Tbl		= 34,	// for ANR table
    eIspTuningMgrFuncBit_Rwb			= 35,	// add for RWB sensor
    eIspTuningMgrFuncBit_Iso			= 36,	// add for ISO adaptive
    eIspTuningMgrFuncBit_Num   //can't over 64
};

enum EIspTuningMgrFunc  // need mapping to ETuningMgrFunc
{
   eIspTuningMgrFunc_Null           = 0x0LL,
   eIspTuningMgrFunc_Dbs            = (1LL<<eIspTuningMgrFuncBit_Dbs       ),
   eIspTuningMgrFunc_Dbs_d          = (1LL<<eIspTuningMgrFuncBit_Dbs_d     ),
   eIspTuningMgrFunc_Obc            = (1LL<<eIspTuningMgrFuncBit_Obc       ),
   eIspTuningMgrFunc_Obc_d          = (1LL<<eIspTuningMgrFuncBit_Obc_d     ),
   eIspTuningMgrFunc_Lsc            = (1LL<<eIspTuningMgrFuncBit_Lsc       ),
   eIspTuningMgrFunc_Lsc_d          = (1LL<<eIspTuningMgrFuncBit_Lsc_d     ),
   eIspTuningMgrFunc_Bnr            = (1LL<<eIspTuningMgrFuncBit_Bnr       ),
   eIspTuningMgrFunc_Bnr_d          = (1LL<<eIspTuningMgrFuncBit_Bnr_d     ),
   eIspTuningMgrFunc_Rpg            = (1LL<<eIspTuningMgrFuncBit_Rpg       ),
   eIspTuningMgrFunc_Rpg_d          = (1LL<<eIspTuningMgrFuncBit_Rpg_d     ),
   eIspTuningMgrFunc_Rmg            = (1LL<<eIspTuningMgrFuncBit_Rmg       ),
   eIspTuningMgrFunc_Rmg_d          = (1LL<<eIspTuningMgrFuncBit_Rmg_d     ),
   eIspTuningMgrFunc_Pgn            = (1LL<<eIspTuningMgrFuncBit_Pgn       ),
   //eIspTuningMgrFunc_Sl2            = (1LL<<eIspTuningMgrFuncBit_Sl2       ),
   eIspTuningMgrFunc_Nsl2            = (1LL<<eIspTuningMgrFuncBit_Nsl2       ),
   //eIspTuningMgrFunc_Cfa            = (1LL<<eIspTuningMgrFuncBit_Cfa       ),
   eIspTuningMgrFunc_Udm            = (1LL<<eIspTuningMgrFuncBit_Udm       ),
   eIspTuningMgrFunc_Ccl            = (1LL<<eIspTuningMgrFuncBit_Ccl       ),
   eIspTuningMgrFunc_G2g            = (1LL<<eIspTuningMgrFuncBit_G2g       ),
   eIspTuningMgrFunc_Ggm_Rb         = (1LL<<eIspTuningMgrFuncBit_Ggm_Rb    ),
   eIspTuningMgrFunc_Ggm_G          = (1LL<<eIspTuningMgrFuncBit_Ggm_G     ),
   eIspTuningMgrFunc_Mfb_TuneCon    = (1LL<<eIspTuningMgrFuncBit_Mfb_TuneCon),
   eIspTuningMgrFunc_G2c_Conv       = (1LL<<eIspTuningMgrFuncBit_G2c_Conv  ),
   eIspTuningMgrFunc_G2c_Shade      = (1LL<<eIspTuningMgrFuncBit_G2c_Shade ),
   eIspTuningMgrFunc_Nbc            = (1LL<<eIspTuningMgrFuncBit_Nbc       ),
   eIspTuningMgrFunc_Pca_Tbl        = (1LL<<eIspTuningMgrFuncBit_Pca_Tbl   ),
   eIspTuningMgrFunc_Pca_Con        = (1LL<<eIspTuningMgrFuncBit_Pca_Con   ),
   eIspTuningMgrFunc_Seee           = (1LL<<eIspTuningMgrFuncBit_Seee      ),
   eIspTuningMgrFunc_Lce            = (1LL<<eIspTuningMgrFuncBit_Lce       ),
   eIspTuningMgrFunc_Nr3d_Blending  = (1LL<<eIspTuningMgrFuncBit_Nr3d_Blending      ),
   eIspTuningMgrFunc_Nr3d_Lmt       = (1LL<<eIspTuningMgrFuncBit_Nr3d_Lmt      ),
   //eIspTuningMgrFunc_Sl2b           = (1LL<<eIspTuningMgrFuncBit_Sl2b      ),
   eIspTuningMgrFunc_Nsl2b          = (1LL<<eIspTuningMgrFuncBit_Nsl2b      ),
   eIspTuningMgrFunc_Sl2c           = (1LL<<eIspTuningMgrFuncBit_Sl2c      ),
   eIspTuningMgrFunc_Mix3           = (1LL<<eIspTuningMgrFuncBit_Mix3      ),
   //eIspTuningMgrFunc_ImgSel         = (1LL<<eIspTuningMgrFuncBit_ImgSel    ),
   //eIspTuningMgrFunc_ImgSel_d       = (1LL<<eIspTuningMgrFuncBit_ImgSel_d  ),
   eIspTuningMgrFunc_Nbc2           = (1LL<<eIspTuningMgrFuncBit_Nbc2       ),
   eIspTuningMgrFunc_Nsl2a          = (1LL<<eIspTuningMgrFuncBit_Nsl2a      ),
   eIspTuningMgrFunc_Nbc_Tbl		= (1LL<<eIspTuningMgrFuncBit_Nbc_Tbl	),	// for ANR table
   eIspTuningMgrFunc_Rwb          = (1LL<<eIspTuningMgrFuncBit_Rwb      ),	// add for RWB sensor
   eIspTuningMgrFunc_Iso          = (1LL<<eIspTuningMgrFuncBit_Iso      ),	// add for ISO adaptive
   eIspTuningMgrFunc_Num            = (1LL<<eIspTuningMgrFuncBit_Num       )
};

typedef struct{
    ISP_TPIPE_CONFIG_SL2_STRUCT sl2;
	ISP_TPIPE_CONFIG_NSL2_STRUCT nsl2;
	...
	ISP_TPIPE_CONFIG_NSL2A_STRUCT nsl2a;
	ISP_TPIPE_CONFIG_NSL2B_STRUCT nsl2b;
...
class IspDrv
{
	...
	virtual MBOOL   checkCQBufAllocated(void) = 0;
        ...
        virtual MUINT64 getTuningUpdateFuncBit(ETuningQueAccessPath ePath, MINT32 magicNum, MINT32 cq,MUINT32 drvScenario) = 0;
        ...
        virtual MBOOL   enqueP2Frame(MUINT32 callerID,MINT32 p2burstQIdx,MINT32 p2dupCQIdx,MINT32 frameNum)=0;
