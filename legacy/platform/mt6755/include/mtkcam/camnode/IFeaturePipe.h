...
#define FEATURE_MASK_ENABLE_EIS_CALIBRATION(x)      (x)|=(1<<7)
#define FEATURE_MASK_IS_EIS_CALIBRATION_ENABLED(x)  ((x&(1<<7))?true:false)
...
#define FEATURE_MASK_ENABLE_SMILE_SHOT(x)             (x)|=(1<<18)
#define FEATURE_MASK_IS_SMILE_SHOT_ENABLED(x)         ((x&(1<<18))?true:false)
...
public:
    ...
    /**
     * @brief init the pipe with FeatureMask input
     *
     * @details
     *
     * @note
     ...
     */        
    virtual MBOOL                   init(MUINT32 iFeatureMask) = 0;
