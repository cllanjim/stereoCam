...
class Pass2Node : public ICamThreadNode
{
    public:     /*createInstance()*/
        ...
        virtual MBOOL       enableSDPreview(MBOOL en) {return MFALSE;};
        virtual MBOOL       waitCurEnqueFrameDone() {return MTRUE;};
        ...
        virtual MBOOL       setGPUProcType(MUINT32 const type) = 0;

        virtual void        setCropRatio(float ratio) = 0;
