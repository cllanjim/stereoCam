...
public:     ////                                Definitions.
    ...
    typedef Pipeline::HdrStrategy::         create_capture_parame_to_halmeta_control
                                                create_capture_parame_to_halmeta_control;
...
public:     ////                    Attributes.
    ...
    virtual MINT32                  getLogLevel() const { return mLogLevel; }

public:     ////                    Operations.
    virtual MERROR                  submitRequest(AppRequest& request, int SubRequestCnt);
