...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_HWPIPELINE_PIPELINEMODEL_HDR_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_HWPIPELINE_PIPELINEMODEL_HDR_H_
//
#include "NodeId.h"
#include "StreamId.h"
...
public:
    // instantiation
    static  PipelineModel_Hdr*      create(MINT32 const openId);
...
#endif  //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_HWPIPELINE_PIPELINEMODEL_HDR_H_
