...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_HWPIPELINE_PIPELINEMODEL_FEATURE_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_HWPIPELINE_PIPELINEMODEL_FEATURE_H_
//
#include "NodeId.h"
#include "StreamId.h"
...
public:     ////                    Instantiation.
    static  PipelineModel_Feature*  create(MINT32 const openId);

public:     ////                    Attributes.
    static  char const*             magicName() { return "PipelineModel_Feature"; }
...
#endif  //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_HWPIPELINE_PIPELINEMODEL_FEATURE_H_
