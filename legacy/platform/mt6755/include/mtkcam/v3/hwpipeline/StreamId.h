...
enum
{
    ...
    //==========================================================================
        ...
        eSTREAMID_META_APP_DYNAMIC_01,         //10
		...
		eSTREAMID_IMAGE_HDR,
		eSTREAMID_META_PIPE_DYNAMIC_HDR,      //15
