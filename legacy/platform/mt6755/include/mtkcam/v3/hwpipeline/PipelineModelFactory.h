...
enum PipelineScene
{
    ePIPELINEMODEL_DEFAULT      = 0x00,
    ePIPELINEMODEL_HDR          = 0x01,
    ePIPELINEMODEL_STEREO       = 0x02,
    ePIPELINEMODEL_OTHERS       = 0x03,
    ePIPELINEMODEL_RESERVED     = 0x04,
    ePIPELINEMODEL_FEATURE      = 0x05,
    e_NUMBER_PIPELINEMODEL
};
