...
public:
    ...
    */
    ...
    /** \brief start, for lifetime modification, start for streaming or capture.
	*   @return error code : (0: success)
	*/
    int start();

    /** \brief stop, for lifetime modification, stop for streaming or capture.
	*   @return error code : (0: success)
	*/
    int stop();
...
//    int setAFLampOffSch(int ms);
    ...
    */
    ...
    int setCaptureFlashOnOff(int en);
    int updateOneFrame();
    int getFlashState();
