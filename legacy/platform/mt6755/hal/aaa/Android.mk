...
LOCAL_SRC_FILES += isp_mgr/isp_mgr_nsl2.cpp
...
LOCAL_SRC_FILES += lsc_mgr/lsc_mgr2_rto.cpp
LOCAL_SRC_FILES += lsc_mgr/lsc_mgr2_rto.thread.cpp
...
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/EventIrq
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/state_mgr
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/state_mgr_n3d
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/state_mgr_af
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/awb_mgr
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/af_mgr
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/pd_mgr
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/ae_mgr
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/flash_mgr
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/flicker
...
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/ResultBufMgr
