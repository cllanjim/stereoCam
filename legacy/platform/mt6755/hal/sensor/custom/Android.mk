...
#-----------------------------------------------------------
# version
MY_CUST_SENSOR_VERSION := $(shell date) rev:1.0.0
...
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM)
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/custom/$(MTK_TARGET_PROJECT)
...
$(MY_CUST_SENSOR_METADATA_FINAL_FILE): $(MY_CUST_SENSOR_METADATA_FILE_LIST)
	@mkdir -p $(dir $@)
	@echo '//this file is auto-generated; do not modify it!' > $@
	@echo '#define MY_CUST_SENSOR_VERSION "$(MY_CUST_SENSOR_VERSION)"' >> $@
	@echo '#define MY_CUST_SENSOR_FTABLE_FILE_LIST "$(MY_CUST_SENSOR_METADATA_FILE_LIST)"' >> $@
