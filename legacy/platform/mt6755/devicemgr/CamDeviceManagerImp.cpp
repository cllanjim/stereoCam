...
//------------------------------------------------------------------------------
    ...
    for (size_t i = 0; i < sensorNum; i++)
    {
        ...
        if(curDevIdx == SENSOR_DEV_MAIN_2){
            i4DeviceNum++; // Add by westalgo to make auxiliary camera visible to users
...
//        i4DeviceNum++;  // don't count it in
    ...
    for (size_t i = 0; i < sensorNum; i++)
    {
        ...
        case SENSOR_DEV_MAIN_2:{
            ...
            MY_LOGI("Stereo 2nd Camera found %zu", i);
            }break;
            //
    ...
    //
    MY_LOGD("i4DeviceNum=%d iSensorsList=0x%08X", i4DeviceNum, iSensorsList);
