...
LOCAL_SRC_FILES += PipelineModel_Feature.cpp
LOCAL_SRC_FILES += ScenarioControl.cpp
LOCAL_SRC_FILES += PipelineResourceMgr.cpp

ifeq ($(MTK_CAM_HDR_SUPPORT), yes)
LOCAL_SRC_FILES += HdrStrategy.cpp
LOCAL_SRC_FILES += PipelineModelBaseHdr.cpp
LOCAL_SRC_FILES += PipelineModelBaseHdr.HdrStrategy.cpp
...
ifeq ($(MTK_CAM_HDR_SUPPORT), yes)
LOCAL_CFLAGS += -DMTK_CAM_HDR_SUPPORT
endif
#
