...
{
    mEnableDebugLog = (1 == property_get_int32("debug.paramsmgr.log", 0));
}
...
getDisplayRotationSupported() const
{
    ...
    //
    MY_LOGD("getDisplayRotationSupported ret = %d (KEY_CAMERA_MODE=%d)(ms8ClientAppMode=%s)", ret ? 1 : 0, CAM_MODE, ms8ClientAppMode.string());
    //
    return ret;
}
