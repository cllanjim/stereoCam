...
using namespace android::camera::v1;
...
// for Dynamic Feature Table
// ****If you don't understand it, never use it****
#define ITEM_AS_MAX_(_item_)                    _item_
#define ITEM_AS_EXTRA_VALUES_(_items_...)       _items_

// the minimum picture size is: 640x480
#define SCENE_AS_DEFAULT_PICTURE_SIZE_SCENE(_macro_item_default_, _macro_item_max_, _macro_extra_item_list_)         \
    MY_LOGI("Use Dynamic Feature Table Algorithm: Picture Sizes..."); \
    char const* szDefaultScene_ItemDefault[] = { _macro_item_default_ };   \
    char const* szDefaultScene_ItemMax[] = { _macro_item_max_ };   \
    char const* szDefaultScene_ExtraItemList   [] = { _macro_extra_item_list_ };                           \
    int  extraItemListSize = sizeof(szDefaultScene_ExtraItemList) / sizeof(szDefaultScene_ExtraItemList[0]);    \
    int picSizesCnt;     \
    char const* *szDefaultScene_PictureSizes = getPicSizes(szDefaultScene_ItemMax[0], &picSizesCnt, facing);       \
    picSizesCnt = addExtraPictureSizes(szDefaultScene_PictureSizes, picSizesCnt, szDefaultScene_ExtraItemList, extraItemListSize);  \
    SceneKeyedMap sceneKeyedMap(szFType, FeatureInfo( szDefaultScene_ItemDefault[0], szDefaultScene_PictureSizes, picSizesCnt )); 

// the minimum preview size is: 640x480
#define SCENE_AS_DEFAULT_PREVIEW_SIZE_SCENE(_macro_item_default_, _macro_item_max_, _macro_extra_item_list_)         \
    MY_LOGI("Use Dynamic Feature Table Algorithm: Preview Sizes..."); \
    char const* szDefaultScene_ItemDefault[] = { _macro_item_default_ };   \
    char const* szDefaultScene_ItemMax[] = { _macro_item_max_ };   \
    char const* szDefaultScene_ExtraItemList   [] = { _macro_extra_item_list_ };                           \
    int  extraItemListSize = sizeof(szDefaultScene_ExtraItemList) / sizeof(szDefaultScene_ExtraItemList[0]);    \
    int prvSizesCnt;     \
    char const* *szDefaultScene_PrvSizes = getPrvSizes(szDefaultScene_ItemMax[0], &prvSizesCnt, facing);       \
    prvSizesCnt = addExtraPreviewSizes(szDefaultScene_PrvSizes, prvSizesCnt, szDefaultScene_ExtraItemList, extraItemListSize);  \
    SceneKeyedMap sceneKeyedMap(szFType, FeatureInfo( szDefaultScene_ItemDefault[0], szDefaultScene_PrvSizes, prvSizesCnt )); 

// the minimum video size is: 640x480
#define SCENE_AS_DEFAULT_VIDEO_SIZE_SCENE(_macro_item_default_, _macro_item_max_, _macro_extra_item_list_)         \
    MY_LOGI("Use Dynamic Feature Table Algorithm: Video Sizes..."); \
    char const* szDefaultScene_ItemDefault[] = { _macro_item_default_ };   \
    char const* szDefaultScene_ItemMax[] = { _macro_item_max_ };   \
    char const* szDefaultScene_ExtraItemList   [] = { _macro_extra_item_list_ };                           \
    int  extraItemListSize = sizeof(szDefaultScene_ExtraItemList) / sizeof(szDefaultScene_ExtraItemList[0]);    \
    int  videoSizesCnt;     \
    char const* *szDefaultScene_VideoSizes = getVideoSizes(szDefaultScene_ItemMax[0], &videoSizesCnt, facing);       \
    videoSizesCnt = addExtraVideoSizes(szDefaultScene_VideoSizes, videoSizesCnt, szDefaultScene_ExtraItemList, extraItemListSize);  \
    SceneKeyedMap sceneKeyedMap(szFType, FeatureInfo( szDefaultScene_ItemDefault[0], szDefaultScene_VideoSizes, videoSizesCnt )); 
