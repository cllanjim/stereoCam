...
)
{
    ...
    MVOID* tuningBuf_main1 = (MVOID*) malloc(sizeof(dip_x_reg_t));
    MVOID* tuningBuf_main2 = (MVOID*) malloc(sizeof(dip_x_reg_t));
    memset(tuningBuf_main1, 0, sizeof(dip_x_reg_t));
    memset(tuningBuf_main2, 0, sizeof(dip_x_reg_t));
