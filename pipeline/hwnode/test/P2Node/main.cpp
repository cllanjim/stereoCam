...
#define addBufPlane(planes, height, stride)                                         \
    ...
    //
    {
        sp<IMetadataProvider> pMetadataProvider = NSMetadataProviderManager::valueFor(gSensorId);
    ...
    params.sensorSize = mActiveArray.s;
