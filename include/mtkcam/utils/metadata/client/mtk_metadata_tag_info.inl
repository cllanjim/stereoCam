...
_IMP_TAG_INFO_( MTK_CONTROL_AVAILABLE_HIGH_SPEED_VIDEO_CONFIGURATIONS,
                MINT32,     "availableHighSpeedVideoConfigurations")
_IMP_TAG_INFO_( MTK_CONTROL_AE_LOCK_AVAILABLE,
                MUINT8,     "aeLockAvailable")
_IMP_TAG_INFO_( MTK_CONTROL_AWB_LOCK_AVAILABLE,
                MUINT8,     "awbLockAvailable")
_IMP_TAG_INFO_( MTK_CONTROL_AVAILABLE_MODES,
                MUINT8,     "availableModes")
_IMP_TAG_INFO_( MTK_CONTROL_POST_RAW_SENSITIVITY_BOOST_RANGE,
                MUINT8,     "postRawSensitivityBoostRange")
_IMP_TAG_INFO_( MTK_CONTROL_POST_RAW_SENSITIVITY_BOOST,
                MUINT8,     "postRawSensitivityBoost")
//
...
_IMP_TAG_INFO_( MTK_SENSOR_OPTICAL_BLACK_REGIONS,
                MINT32,     "opticalBlackRegions")
_IMP_TAG_INFO_( MTK_SENSOR_DYNAMIC_BLACK_LEVEL,
                MFLOAT,     "dynamicBlackLevel")
_IMP_TAG_INFO_( MTK_SENSOR_DYNAMIC_WHITE_LEVEL,
                MINT32,     "dynamicWhiteLevel")
_IMP_TAG_INFO_( MTK_SENSOR_OPAQUE_RAW_SIZE,
                MSize,     "opaqueRawSize")
//
...
_IMP_TAG_INFO_( MTK_FACE_FEATURE_FORCE_FACE_3A,
                MINT32,     "forceface3a")

_IMP_TAG_INFO_( MTK_FACE_FEATURE_AVAILABLE_FORCE_FACE_3A,
                MINT32,     "availableforceface3a")
...
_IMP_TAG_INFO_( MTK_HDR_FEATURE_HDR_MODE,
                MINT32,     "hdrMode")

_IMP_TAG_INFO_( MTK_HDR_FEATURE_VHDR_MODE,
                MINT32,     "vhdrMode")

_IMP_TAG_INFO_( MTK_HDR_FEATURE_AVAILABLE_HDR_MODES,
                MINT32,     "availableHdrModes")

_IMP_TAG_INFO_( MTK_HDR_FEATURE_AVAILABLE_VHDR_MODES,
                MINT32,     "availableVhdrModes")

_IMP_TAG_INFO_( MTK_STEREO_FEATURE_DOF_LEVEL,
                MINT32,   "doflevel")

_IMP_TAG_INFO_( MTK_STEREO_FEATURE_SUPPORTED_DOF_LEVEL,
                MINT32,   "supporteddoflevel")

_IMP_TAG_INFO_( MTK_STEREO_FEATURE_RESULT_DOF_LEVEL,
                MINT32,   "resultdoflevel")

_IMP_TAG_INFO_( MTK_STEREO_FEATURE_WARNING,
                MINT32,   "stereowarning")

_IMP_TAG_INFO_( MTK_STEREO_FEATURE_DEPTH_AF_ON,
                MINT32,   "depthafon")

_IMP_TAG_INFO_( MTK_STEREO_FEATURE_DISTANCE_MEASURE_ON,
                MINT32,   "distancemeasureon")

_IMP_TAG_INFO_( MTK_STEREO_FEATURE_RESULT_DISTANCE,
                MFLOAT,   "resultdistance")
